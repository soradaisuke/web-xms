...
function useColumnValueOptions(column, generateFunc, forForm, initialValueOptions) {
  ...
  var filters = (0, _react.useMemo)(function () {
    return column.getFilters(parentFilterValue, forForm ? 'disabledInForm' : 'disabledInFilter');
    ...
    if (!options) {
      if (filters) {
        ...
        request.then(function () {
          return setOptions(generateFunc(column.getFilters(parentFilterValue, forForm ? 'disabledInForm' : 'disabledInFilter')));
        }, function () {});
        return function () {
