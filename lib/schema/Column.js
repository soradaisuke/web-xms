  ...
  (0, _createClass2.default)(Column, [{
    ...
    value: function getTableSortDirections() {
      if (!this.sortDirections) {
        this.sortDirections = this.config.getIn(['table', 'columnProps', 'sortDirections'], _immutable.default.List()).toArray();
      }
    ...
    key: "getFilterPresets",
    value: function getFilterPresets() {
    ...
    value: function getFilterKey() {
      return this.config.getIn(['table', 'filterFormItemProps', 'name']) || this.getKey();
    }
  }, {
    ...
    key: "getFormPresets",
    value: function getFormPresets() {
      return this.config.getIn(['form', 'presets'], _immutable.default.List([]));
    }
  }, {
    key: "getFormItemAvailableWhen",
    value: function getFormItemAvailableWhen() {
      if (!this.formItemAvailableWhen) {
        this.formItemAvailableWhen = this.config.getIn(['form', 'availableWhen'], _immutable.default.List()).toJS();
      }
    ...
    value: function getFormItemRules() {
      if (!this.formItemRules) {
        this.formItemRules = this.config.getIn(['form', 'formItemProps', 'rules'], _immutable.default.List()).toArray();
      }
    ...
    value: function getFormItemLabel() {
      return this.config.getIn(['form', 'formItemProps', 'label'], this.getTitle());
    }
  }, {
