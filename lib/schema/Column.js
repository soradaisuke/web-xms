...
var Column = function () {
  ...
  (0, _createClass2.default)(Column, [{
    ...
    key: "isCustomize",
    value: function isCustomize() {
      return !!this.config.getIn(['table', 'customize']);
    }
  }, {
    key: "isCustomizeDefaultSelected",
    value: function isCustomizeDefaultSelected() {
    ...
    value: function shouldRenderTableFilter(user) {
      return this.canFilterInTable() && !this.shouldRenderOutsideFilter({
        user: user
    ...
    value: function shouldRenderOutsideFilter(user) {
      return this.canFilterInTable() && !this.canFilterExpand() && (this.isFilterOutside() || !this.canShowInTable({
        user: user
      }));
    }
  }, {
    ...
    key: "canShowInTable",
    value: function canShowInTable(_ref3) {
      var user = _ref3.user,
          selectedCustomizeMap = _ref3.selectedCustomizeMap;
      var invisible = this.config.getIn(['table', 'invisible']);
      var customizeColumnCanShow = !this.isCustomize() || !selectedCustomizeMap || selectedCustomizeMap.get(this.getKey());
    ...
    value: function renderInTableValueDefault(_ref4) {
    ...
    value: function renderInTableValue(_ref5) {
      var _this4 = this;
    ...
    key: "renderInTable",
    value: function renderInTable(_ref6) {
      var value = _ref6.value,
          record = _ref6.record,
          user = _ref6.user,
          parentFilteredValue = _ref6.parentFilteredValue;
    ...
    value: function getRenderFilterTree(_ref7) {
      var _this5 = this;

      var parentValue = _ref7.parentValue;
      return function (_ref8) {
        var setSelectedKeys = _ref8.setSelectedKeys,
            ...
            isAutoTrigger = _ref8.isAutoTrigger;
        return _react.default.createElement("div", {
          style: {
            padding: 8
          }
    ...
    key: "renderInForm",
    value: function renderInForm(_ref12) {
      var _this6 = this;

      var user = _ref12.user,
          record = _ref12.record,
          form = _ref12.form,
          isEdit = _ref12.isEdit,
          checkVisibility = _ref12.checkVisibility;
      ...
      if (this.useValueOptionsInForm() && (this.getFilters(parentValue) || this.getValueOptionsRequest() || this.getFormSearchRequest())) {
        ...
        var renderInFormItem = this.config.getIn(['form', 'renderInFormItem']);
        children = renderInFormItem ? renderInFormItem({
          user: user,
          isEdit: isEdit,
          value: value,
          values: values,
    ...
    value: function canShowInDescription(_ref13) {
    ...
    value: function renderInDescriptionDefault(_ref14) {
    ...
    value: function renderInDescriptionValue(_ref15) {
      var _this7 = this;
    ...
    value: function renderInDescription(_ref16) {
