...
var Column = function () {
  (0, _createClass2.default)(Column, null, [{
    key: "isOptionsDisabled",
    value: function isOptionsDisabled(option, key) {
      if (key === Column.VALUE_OPTIONS_KEYS.DISABLED_IN_FILTER) {
        return (0, _get2.default)(option, Column.VALUE_OPTIONS_KEYS.DISABLED_IN_FILTER) || (0, _get2.default)(option, Column.VALUE_OPTIONS_KEYS.DISABLED_IN_FILTER);
      }

      if (key === Column.VALUE_OPTIONS_KEYS.DISABLED_IN_FORM) {
        return (0, _get2.default)(option, Column.VALUE_OPTIONS_KEYS.DISABLED_IN_FORM) || (0, _get2.default)(option, Column.VALUE_OPTIONS_KEYS.DISABLED_IN_FORM);
      }

      return false;
    }
  }, {
    key: "generateValidOptions",
    value: function generateValidOptions(options, disableKey) {
      if (options && options.length > 0) {
        return (0, _map2.default)((0, _filter2.default)(options, function (o) {
          return !disableKey || !Column.isOptionsDisabled(o, disableKey);
        }), function (o) {
    ...
    key: "generateFilters",
    value: function generateFilters(options) {
      return _immutable.default.Map({
        normal: Column.generateValidOptions(options),
        disabledInFilter: Column.generateValidOptions(options, Column.VALUE_OPTIONS_KEYS.DISABLED_IN_FILTER),
        disabledInForm: Column.generateValidOptions(options, Column.VALUE_OPTIONS_KEYS.DISABLED_IN_FORM)
      });
    }
  }, {
    key: "findOption",
    value: function findOption(options, value) {
      if (!options) {
        return null;
      }
  ...
  function Column() {
    ...
    this.config = _immutable.default.fromJS((0, _migrate.migrateColumn)(config));
  ...
  (0, _createClass2.default)(Column, [{
    ...
    key: "getFilterRender",
    value: function getFilterRender() {
      var filterRender;

      if ((0, _isUndefined2.default)(filterRender)) {
        var _filterRender;

        filterRender = this.config.getIn(['table', 'filterRender'], null);

        if ((_filterRender = filterRender) === null || _filterRender === void 0 ? void 0 : _filterRender.toJS) {
    ...
    value: function getFilters(parentFilteredValue) {
      ...
      var key = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Column.VALUE_OPTIONS_KEYS.NORMAL;
    ...
    value: function getFilterDefault() {
      if (!this.filterDefault) {
        var _this$filterDefault;

        this.filterDefault = this.config.getIn(['table', 'filterDefault']);

        if ((_this$filterDefault = this.filterDefault) === null || _this$filterDefault === void 0 ? void 0 : _this$filterDefault.toJS) {
    ...
    key: "canFilter",
    value: function canFilter(user) {
      var configFilter = this.config.getIn(['table', 'filter']);

      if ((0, _isFunction2.default)(configFilter)) {
        return configFilter({
          user: user
        });
      }
    ...
    value: function getFilterKey() {
      if (!this.filterKey) {
        this.filterKey = this.config.getIn(['table', 'filterFormItemProps', 'name'], this.config.getIn(['table', 'filterKey'], this.getKey()));
    ...
    key: "getFilterFormPlaceholder",
    value: function getFilterFormPlaceholder() {
      return this.config.getIn(['table', 'filterFormItemComponentProps', 'placeholder'], "\u8BF7\u8F93\u5165".concat(this.getTitle()));
    }
  }, {
    key: "canEdit",
    ...
    key: "canShowInForm",
    value: function canShowInForm(_ref4) {
      var user = _ref4.user,
          record = _ref4.record;
      return this.canShowInCreateFrom({
        user: user
    ...
    value: function canShowInCreateFrom(_ref5) {
      var user = _ref5.user;
    ...
    value: function canShowInEditFrom(_ref6) {
      var user = _ref6.user,
          record = _ref6.record;
    ...
    value: function getFormItemName() {
      if (!this.formItemName) {
        this.formItemName = this.config.getIn(['form', 'formItemProps', 'name'], this.config.getIn(['form', 'key'], this.getKey()));
    ...
    value: function getFormItemInitialValue() {
      if (!this.formItemInitialValue) {
        var _this$formItemInitial;

        this.formItemInitialValue = this.config.getIn(['form', 'formItemProps', 'initialValue'], this.config.getIn(['form', 'initialValue']));

        if ((_this$formItemInitial = this.formItemInitialValue) === null || _this$formItemInitial === void 0 ? void 0 : _this$formItemInitial.toJS) {
    ...
    key: "getFormItemInitialListItemValue",
    value: function getFormItemInitialListItemValue() {
      if (!this.formItemInitialListItemValue) {
        var _this$formItemInitial2;

        this.formItemInitialListItemValue = this.config.getIn(['form', 'initialListItemValue']);

        if ((_this$formItemInitial2 = this.formItemInitialListItemValue) === null || _this$formItemInitial2 === void 0 ? void 0 : _this$formItemInitial2.toJS) {
    ...
    key: "getFormItemInitialValueOptionsRequest",
    value: function getFormItemInitialValueOptionsRequest() {
    ...
    value: function canShowInDescription(_ref7) {
      var user = _ref7.user,
          record = _ref7.record;
      ...
      if (valueOptionsRequest) {
        if (this.getParentKey()) {
            ...
            if ((0, _isArray2.default)(parentFilteredValue)) {
              promise = Promise.all(parentFilteredValue.map(function (v) {
                ...
                return valueOptionsRequest(v).then(function (result) {
                  _this2.filters = _this2.filters.set(v, Column.generateFilters(result));
                });
              })).then(function () {
              ...
              promise = valueOptionsRequest(parentFilteredValue).then(function (result) {
                _this2.filters = _this2.filters.set(parentFilteredValue, Column.generateFilters(result));
                _this2.activeValueOptionsRequests[parentFilteredValue] = null;
              });
            }
          ...
          this.activeValueOptionsRequests[parentFilteredValue] = valueOptionsRequest().then(function (result) {
            _this2.filters = Column.generateFilters(result);
            _this2.activeValueOptionsRequests[parentFilteredValue] = null;
          });
          return this.activeValueOptionsRequests[parentFilteredValue];
        } else {
...
(0, _defineProperty2.default)(Column, "VALUE_OPTIONS_KEYS", {
  NORMAL: 'normal',
