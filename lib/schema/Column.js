...
var Column = function () {
  ...
  (0, _createClass2.default)(Column, [{
    ...
    value: function getRenderFilterTree(_ref6) {
      ...
      return function (_ref7) {
        var setSelectedKeys = _ref7.setSelectedKeys,
            ...
            isAutoTrigger = _ref7.isAutoTrigger;
        return _react.default.createElement("div", {
          style: {
            padding: 8
          }
    ...
    value: function isImmutableInForm(_ref8) {
      var user = _ref8.user,
          value = _ref8.value,
          values = _ref8.values,
          record = _ref8.record;
    ...
    value: function canShowInCreateFrom(_ref9) {
      var user = _ref9.user,
          value = _ref9.value,
          values = _ref9.values,
          record = _ref9.record;
    ...
    value: function canShowInEditFrom(_ref10) {
    ...
    value: function getFormComponentProps(_ref11) {
    ...
    value: function renderCommonFormItem(_ref12) {
      var isEdit = _ref12.isEdit,
          user = _ref12.user,
          record = _ref12.record,
          value = _ref12.value,
          values = _ref12.values,
          parentValue = _ref12.parentValue,
          formComponentProps = _ref12.formComponentProps;
      var children;
      ...
      if (this.getFormExpandable() && this.parentValue(parentValue)) {
        ...
        var options = (0, _filter2.default)(this.getFilters(parentValue), function (_ref13) {
          var disableInForm = _ref13.disableInForm;
    ...
    value: function generateFormInitialValue() {
      ...
      var _ref14 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          _ref14$isEdit = _ref14.isEdit,
          isEdit = _ref14$isEdit === void 0 ? false : _ref14$isEdit,
          _ref14$record = _ref14.record,
          record = _ref14$record === void 0 ? {} : _ref14$record,
          parentValue = _ref14.parentValue;
    ...
    key: "renderInForm",
    value: function renderInForm(_ref15) {
      var _this7 = this;

      var hideFormLabel = _ref15.hideFormLabel,
          user = _ref15.user,
          record = _ref15.record,
          form = _ref15.form,
          isEdit = _ref15.isEdit,
          checkVisibility = _ref15.checkVisibility,
          _ref15$isFilter = _ref15.isFilter,
          isFilter = _ref15$isFilter === void 0 ? false : _ref15$isFilter,
          formComponentProps = _ref15.formComponentProps;

      var _ref16 = form || {},
          getFieldsValue = _ref16.getFieldsValue,
          getFieldDecorator = _ref16.getFieldDecorator;
      ...
      return _react.default.createElement(FormItem, {
        ...
        onChange: this.childColumn ? function () {
          (0, _forEach2.default)(_this7.childColumn, function (childColumn) {
    ...
    value: function canShowInDescription(_ref17) {
    ...
    value: function renderInDescriptionDefault(_ref18) {
    ...
    value: function renderInDescriptionValue(_ref19) {
      var _this8 = this;
      ...
      if ((0, _isArray2.default)(value)) {
        return _react.default.createElement(_react.default.Fragment, null, (0, _map2.default)(value, function (v) {
          return _react.default.createElement(_react.default.Fragment, {
            key: v
          }, _this8.renderInDescriptionDefault({
            value: v,
            record: record
          }), _react.default.createElement("br", null));
        }));
    ...
    value: function renderInDescription(_ref20) {
      var value = _ref20.value,
          record = _ref20.record;
      ...
      if (valueOptionsRequest) {
        if (this.getParentKey()) {
          ...
          if (!this.activeValueOptionsRequests[parentFilteredValue] && !(0, _isUndefined2.default)(parentFilteredValue)) {
            ...
            if ((0, _isArray2.default)(parentFilteredValue)) {
              promise = Promise.all(parentFilteredValue.map(function (v) {
                if (_this9.filters.get(v)) {
                  return Promise.resolve(v);
                }

                return valueOptionsRequest(v).then(function (result) {
                  _this9.filters = _this9.filters.set(v, generateFilters(result));
                });
              })).then(function () {
                _this9.activeValueOptionsRequests[parentFilteredValue] = null;
              });
            } else {
              promise = valueOptionsRequest(parentFilteredValue).then(function (result) {
                _this9.filters = _this9.filters.set(parentFilteredValue, generateFilters(result));
                _this9.activeValueOptionsRequests[parentFilteredValue] = null;
              });
            }
          ...
          this.activeValueOptionsRequests[parentFilteredValue] = valueOptionsRequest().then(function (result) {
            _this9.filters = generateFilters(result);
            _this9.activeValueOptionsRequests[parentFilteredValue] = null;
          });
          return this.activeValueOptionsRequests[parentFilteredValue];
        } else {
      ...
      if (filterSearchRequest) {
        if (!this.activefilterSearchRequest) {
          this.activefilterSearchRequest = filterSearchRequest(value).then(function (result) {
            _this10.filters = _this10.filters.set('search', result);
            _this10.activefilterSearchRequest = null;
          });
