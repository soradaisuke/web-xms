...
function isOptionsDisabled(option, key) {
  if (key === 'disabledInFilter') {
    return (0, _get2.default)(option, 'disabledInFilter') || (0, _get2.default)(option, 'disableInFilter');
  }

  if (key === 'disabledInForm') {
    return (0, _get2.default)(option, 'disabledInForm') || (0, _get2.default)(option, 'disabledInForm');
  }
...
function generateValidOptions(options, disableKey) {
  if (options && options.length > 0) {
    return (0, _map2.default)((0, _filter2.default)(options, function (o) {
      return !disableKey || !isOptionsDisabled(o, disableKey);
    }), function (o) {
...
function migrateConfig(_ref) {
  ...
  _ref$table = _ref$table === void 0 ? {} : _ref$table;
  var defaultSortOrder = _ref$table.defaultSortOrder,
      fixedSortOrder = _ref$table.fixedSortOrder,
      fixed = _ref$table.fixed,
      link = _ref$table.link,
      columnProps = _ref$table.columnProps,
      filterComponentProps = _ref$table.filterComponentProps,
      format = _ref$table.format,
      table = (0, _objectWithoutProperties2.default)(_ref$table, ["defaultSortOrder", "fixedSortOrder", "fixed", "link", "columnProps", "filterComponentProps", "format"]),
      _ref$form = _ref.form;
  _ref$form = _ref$form === void 0 ? {} : _ref$form;
  var componentProps = _ref$form.componentProps,
      generateInitialValue = _ref$form.generateInitialValue,
      generateSubmitValue = _ref$form.generateSubmitValue,
      renderInFormItem = _ref$form.renderInFormItem,
      radioOptions = _ref$form.radioOptions,
      searchPlaceholder = _ref$form.searchPlaceholder,
      searchRequest = _ref$form.searchRequest,
      form = (0, _objectWithoutProperties2.default)(_ref$form, ["componentProps", "generateInitialValue", "generateSubmitValue", "renderInFormItem", "radioOptions", "searchPlaceholder", "searchRequest"]),
      config = (0, _objectWithoutProperties2.default)(_ref, ["table", "form"]);
  ...
  if (defaultSortOrder) {
    console.warn("Column's config.table.fixed is deprecated, please use config.table.columnProps");
  }
  ...
  return _objectSpread({
    table: _objectSpread({
      ...
      columnProps: _objectSpread({
        fixed: fixed
      }, columnProps !== null && columnProps !== void 0 ? columnProps : {})
    }, table !== null && table !== void 0 ? table : {}),
    form: _objectSpread({
...
var Column = function () {
  ...
  (0, _createClass2.default)(Column, [{
    ...
    key: "getFilterOption",
    value: function getFilterOption(_ref2) {
      var value = _ref2.value,
          parentFilterValue = _ref2.parentFilterValue;
    ...
    value: function isImmutableInForm(_ref4) {
      var user = _ref4.user,
          record = _ref4.record;
