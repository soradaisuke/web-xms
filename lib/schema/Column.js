...
var Column = function () {
  ...
  (0, _createClass2.default)(Column, [{
    ...
    value: function renderInForm(_ref12) {
      ...
      var hideFormLabel = _ref12.hideFormLabel,
          user = _ref12.user,
          record = _ref12.record,
          form = _ref12.form,
          isEdit = _ref12.isEdit,
          checkVisibility = _ref12.checkVisibility,
          _ref12$isFilter = _ref12.isFilter,
          isFilter = _ref12$isFilter === void 0 ? false : _ref12$isFilter,
          formComponentProps = _ref12.formComponentProps;

      var _ref13 = form || {},
          getFieldsValue = _ref13.getFieldsValue,
          getFieldDecorator = _ref13.getFieldDecorator;
      ...
      if (this.useValueOptionsInForm() && (this.getFilters(parentValue) || this.getValueOptionsRequest() || this.getFormSearchRequest())) {
        if (this.getFormExpandable() && this.getFilters(parentValue)) {
          ...
          var options = (0, _filter2.default)(this.getFilters(parentValue), function (_ref14) {
            var disableInForm = _ref14.disableInForm;
    ...
    value: function canShowInDescription(_ref15) {
    ...
    value: function renderInDescriptionDefault(_ref16) {
    ...
    value: function renderInDescriptionValue(_ref17) {
      var _this7 = this;
    ...
    value: function renderInDescription(_ref18) {
