...
var Column = function () {
  ...
  (0, _createClass2.default)(Column, [{
    ...
    value: function renderInTableValueDefault(_ref3) {
      ...
      if (filters) {
        var option = filters.find(function (o) {
    ...
    value: function renderInForm(_ref8) {
      ...
      var user = _ref8.user,
          ...
          form = _ref8.form,
          isEdit = _ref8.isEdit,
          checkVisibility = _ref8.checkVisibility;
    ...
    value: function canShowInDescription(user) {
    ...
    value: function renderInDescriptionDefault(_ref9) {
    ...
    value: function renderInDescriptionValue(_ref10) {
      var _this6 = this;
    ...
    value: function renderInDescription(_ref11) {
            ...
            switch (_context.prev = _context.next) {
                ...
                if ((0, _isArray2.default)(parentFilteredValue)) {
                  promise = Promise.all(parentFilteredValue.map(function (v) {
                    ...
                    return valueOptionsRequest(v).then(function (result) {
                      _this7.filters = _this7.filters.set(v, generateValidOptions(_immutable.default.fromJS(result)));
                    });
                  })).then(function () {
                  ...
                  promise = valueOptionsRequest(parentFilteredValue).then(function (result) {
                    _this7.filters = _this7.filters.set(parentFilteredValue, generateValidOptions(_immutable.default.fromJS(result)));
                    _this7.activeValueOptionsRequest = null;
                  });
                }
              ...
              case 11:
                ...
                this.activeValueOptionsRequest = valueOptionsRequest().then(function (result) {
                  _this7.filters = generateValidOptions(_immutable.default.fromJS(result));
                  _this7.activeValueOptionsRequest = null;
                });
                return _context.abrupt("return", this.activeValueOptionsRequest);
