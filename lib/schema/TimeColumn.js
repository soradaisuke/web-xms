...
var TimeColumn = function (_NumberColumn) {
  ...
  function TimeColumn() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderFilterDropDownContent", function (_ref) {
      ...
      if (_this.canFilterRangeInTable()) {
        ...
        }, _react.default.createElement(_TimePickerWithConfirm.default, (0, _extends2.default)({}, _this.getTableFilterComponentProps().toJS(), {
      ...
      return _react.default.createElement(_TimePickerWithConfirm.default, (0, _extends2.default)({}, _this.getTableFilterComponentProps().toJS(), {
        format: _this.getInTableFormat(),
  ...
  (0, _createClass2.default)(TimeColumn, [{
    ...
    value: function renderInFormItem() {
      return _react.default.createElement(_timePicker.default, this.getFormComponentProps().toJS());
    }
  }, {
