...
var StringColumn = function (_Column) {
  ...
  (0, _createClass2.default)(StringColumn, [{
    ...
    value: function renderInFormItem(_ref2) {
      ...
      if (this.canSelectMutipleInForm()) {
        return _react.default.createElement(_select.default, (0, _extends2.default)({}, formComponentProps, {
          style: {
            width: '100%'
          },
          mode: "tags",
      ...
      if (this.getFormMultipleLine()) {
        return _react.default.createElement(_input.default.TextArea, (0, _extends2.default)({}, formComponentProps, {
          style: {
            width: '100%'
          },
          placeholder: this.getFormPlaceholder()
      ...
      return _react.default.createElement(_input.default, (0, _extends2.default)({}, formComponentProps, {
        style: {
          width: '100%'
        },
        placeholder: this.getFormPlaceholder()
