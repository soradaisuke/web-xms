  ...
  function BaseDateTimeColumn() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderFilterDropDownContent", function (_ref) {
      ...
      if (_this.canFilterRangeInTable()) {
        return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(RangePicker, (0, _extends2.default)({}, _this.getTableFilterComponentProps(), {
          allowClear: false,
      ...
      return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_datePicker.default, (0, _extends2.default)({}, _this.getTableFilterComponentProps(), {
        showTime: _this.showTime(),
        allowClear: false,
        format: _this.getInTableFormat(),
