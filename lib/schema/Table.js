...
var _findCascadeColumn2 = _interopRequireDefault(require("../utils/findCascadeColumn"));
...
var Table = function () {
  ...
  (0, _createClass2.default)(Table, [{
    ...
    value: function findDefaultFilter() {
      ...
      this.columns.forEach(function (column) {
        ...
        if (column.getTableFilterDefault()) {
          _this.defaultFilter = _this.defaultFilter || {};
          _this.defaultFilter[column.getTableFilterKey()] = column.getTableFilterDefault();
        }
      });
    }
  }, {
    ...
    value: function findCascadeColumn() {
      (0, _findCascadeColumn2.default)(this.columns);
    }
  }, {
    ...
    value: function findHasFilter() {
      this.hasFilter = this.columns.findIndex(function (column) {
