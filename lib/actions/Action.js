    ...
    value: function renderInteral(_ref) {
      ...
      if (confirmTitle) {
        click = function click() {
          return modalConfirm(_objectSpread(_objectSpread({}, _this2.getConfirmComponentProps()), {}, {
            title: (0, _isFunction2.default)(confirmTitle) ? confirmTitle(params) : confirmTitle,
    ...
    value: function render(_ref2) {
      ...
      if (this.canHandleGlobal()) {
        ...
        filteredRecords = records ? (0, _filter2.default)(records, function (r) {
          return (0, _isFunction2.default)(enable) ? enable(_objectSpread(_objectSpread({}, params), {}, {
            records: null,
            record: r
          })) : true;
        }) : null;
      ...
      if ((0, _isFunction2.default)(render)) {
        return render(_objectSpread(_objectSpread({}, params), {}, {
          reload: confirm
        }));
      }
      ...
      if (this.getLink() && !disabled) {
        buttonProps.children = _react.default.createElement(_react.default.Fragment, null, buttonProps.children, _react.default.createElement(_RecordLink.default, {
          style: {
            width: '100%',
            height: '100%',
            position: 'absolute',
