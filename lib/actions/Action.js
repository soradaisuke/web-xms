    ...
    value: function renderInteral(_ref) {
      ...
      if (confirmTitle) {
        click = function click() {
          return modalConfirm((0, _objectSpread2.default)({}, _this.getConfirmComponentProps(), {
            title: (0, _isFunction2.default)(confirmTitle) ? confirmTitle(params) : confirmTitle,
    ...
    value: function render(_ref2) {
      ...
      var onClick = function onClick() {
        var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
            ...
            loadingMessage = _ref3$loadingMessage === void 0 ? _this2.getHandlingMessage() : _ref3$loadingMessage,
            _ref3$throwError = _ref3.throwError,
            throwError = _ref3$throwError === void 0 ? false : _ref3$throwError,
            _ref3$reload = _ref3.reload,
            reload = _ref3$reload === void 0 ? _this2.needReload() : _ref3$reload;

        if ((0, _isFunction2.default)(handler)) {
          var promise;

          if (_this2.canHandleGlobal()) {
