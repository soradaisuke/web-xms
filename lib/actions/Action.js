...
var Action = function () {
  ...
  (0, _createClass2.default)(Action, [{
    ...
    value: function render(_ref2) {
      ...
      var onComplete = this.getOnComplete();
      var children;
      ...
      var onClick = function onClick() {
        var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
            ...
            loadingMessage = _ref3$loadingMessage === void 0 ? _this3.getHandlingMessage() : _ref3$loadingMessage,
            _ref3$throwError = _ref3.throwError,
            throwError = _ref3$throwError === void 0 ? false : _ref3$throwError,
            _ref3$reload = _ref3.reload,
            reload = _ref3$reload === void 0 ? _this3.needReload() : _ref3$reload;

        if ((0, _isFunction2.default)(handler)) {
          var promise;

          if (_this3.canHandleGlobal()) {
            var handlerParams = (0, _objectSpread2.default)({}, params, data);
            promise = handler(handlerParams).then(function () {
              if ((0, _isFunction2.default)(onComplete)) {
                onComplete(handlerParams);
              }
            });
          } else if (filteredRecords) {
            promise = Promise.all((0, _map2.default)(filteredRecords, function (r) {
              var handlerParams = (0, _objectSpread2.default)({}, params, {
                records: null,
                record: r,
                id: (0, _get2.default)(r, table.getPrimaryKey())
              }, data);
              return handler(handlerParams).then(function () {
                if ((0, _isFunction2.default)(onComplete)) {
                  onComplete(handlerParams);
                }
              });
            ...
            var _handlerParams = (0, _objectSpread2.default)({}, params, {
              id: (0, _get2.default)(record, table.getPrimaryKey())
            }, data);

            promise = handler(_handlerParams).then(function () {
              if ((0, _isFunction2.default)(onComplete)) {
                onComplete(_handlerParams);
              }
            });
          }
