...
function generateModel(_ref11, service) {
  ...
  var model = {
    ...
    reducers: {
      ...
      saveFilters: function saveFilters(state, _ref13) {
        ...
        return state.set('schema', state.get('schema').setIn([index, 'filters'], filters).setIn([index, 'enabledFilters'], filters.filter(function (_ref14) {
          var disabled = _ref14.disabled;
          return !disabled;
        })));
      },
      saveError: function saveError(state, _ref15) {
        var error = _ref15.payload.error;
        return state.set('error', error);
      }
    },
    effects: {
      fetch: [_regenerator.default.mark(function fetch(_ref16, _ref17) {
        var _ref16$payload, path, page, pagesize, sort, _ref16$payload$search, search, _ref16$payload$filter, filter, call, put, currentFiler, i, _ref18, records, total;

        return _regenerator.default.wrap(function fetch$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _ref16$payload = _ref16.payload, path = _ref16$payload.path, page = _ref16$payload.page, pagesize = _ref16$payload.pagesize, sort = _ref16$payload.sort, _ref16$payload$search = _ref16$payload.search, search = _ref16$payload$search === void 0 ? {} : _ref16$payload$search, _ref16$payload$filter = _ref16$payload.filter, filter = _ref16$payload$filter === void 0 ? {} : _ref16$payload$filter;
              ...
              case 13:
                ...
                return call(service.fetch, {
                  ...
                  page: page,
                  pagesize: pagesize,
                  filter: (0, _stringify.default)(currentFiler),
                  order: sort
                });

              case 16:
                _ref18 = _context6.sent;
                records = _ref18.items;
                total = _ref18.total;
                _context6.next = 21;
                return put({
                  type: 'save',
      ...
      getFilters: _regenerator.default.mark(function getFilters(_ref19, _ref20) {
        var _ref19$payload, index, filtersFunc, currentFiler, call, put, filters;

        return _regenerator.default.wrap(function getFilters$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _ref19$payload = _ref19.payload, index = _ref19$payload.index, filtersFunc = _ref19$payload.filtersFunc, currentFiler = _ref19$payload.currentFiler;
  ...
  (0, _forEach2.default)(actions, function (action) {
    if (action === 'create') {
      model.effects.create = _regenerator.default.mark(function modelCreate(_ref21, _ref22) {
      ...
      model.effects.edit = _regenerator.default.mark(function modelEdit(_ref23, _ref24) {
      ...
      model.effects.remove = _regenerator.default.mark(function modelRemove(_ref25, _ref26) {
      ...
      model.effects.order = _regenerator.default.mark(function modelOrder(_ref27, _ref28) {
        var _ref27$payload, path, body, diff, call;

        return _regenerator.default.wrap(function modelOrder$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _ref27$payload = _ref27.payload, path = _ref27$payload.path, body = _ref27$payload.body, diff = _ref27$payload.diff;
                call = _ref28.call;
                _context11.next = 4;
...
function generateRecordsPage(_ref29, component) {
  var _ref29$api = _ref29.api,
      host = _ref29$api.host,
      path = _ref29$api.path,
      defaultFilter = _ref29$api.defaultFilter,
      namespace = _ref29.namespace,
      actions = _ref29.actions,
      primaryKey = _ref29.primaryKey,
      schema = _ref29.schema,
      searchFileds = _ref29.searchFileds,
      fixedSort = _ref29.fixedSort,
      defaultSort = _ref29.defaultSort,
      defaultFilterQuery = _ref29.defaultFilter;
  var customActions = actions.filter(function (action) {
    return (0, _isPlainObject2.default)(action);
  });
  var customGlobalActions = customActions.filter(function (_ref30) {
    var global = _ref30.global;
    return global;
  });
  var customMultipleActions = customActions.filter(function (_ref31) {
    var multiple = _ref31.multiple;
    return multiple;
  });
  var customRowActions = customActions.filter(function (_ref32) {
    var global = _ref32.global;
    return !global;
  });
  var dateFilterSchemas = schema.filter(function (_ref33) {
    var type = _ref33.type,
        canFilter = _ref33.canFilter;
    return canFilter && (type === _ColumnTypes.default.date || type === _ColumnTypes.default.datetime);
  });
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    ...
    var props = {
      fetch: function () {
        var _fetch2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(_ref34) {
          var page, pagesize, sort, search, _ref34$filter, filter, queries, uri;

          return _regenerator.default.wrap(function _callee6$(_context12) {
            while (1) {
              switch (_context12.prev = _context12.next) {
                case 0:
                  page = _ref34.page, pagesize = _ref34.pagesize, sort = _ref34.sort, search = _ref34.search, _ref34$filter = _ref34.filter, filter = _ref34$filter === void 0 ? {} : _ref34$filter;
                  queries = (0, _queryString.parse)(location.search);

                  if (!(fixedSort && fixedSort !== sort || (defaultSort || defaultFilterQuery) && (!queries || (0, _keys.default)(queries).length === 0))) {
                    _context12.next = 6;
                    break;
                  }

                  uri = (0, _generateUri2.default)(window.location.href, {
                    filter: (0, _stringify.default)(defaultFilterQuery),
      ...
      updatePage: function () {
        var _updatePage = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref35) {
          var page, pagesize, sort, search, _ref35$filter, filter, uri;

          return _regenerator.default.wrap(function _callee7$(_context13) {
            while (1) {
              switch (_context13.prev = _context13.next) {
                case 0:
                  page = _ref35.page, pagesize = _ref35.pagesize, sort = _ref35.sort, search = _ref35.search, _ref35$filter = _ref35.filter, filter = _ref35$filter === void 0 ? {} : _ref35$filter;
                  uri = (0, _generateUri2.default)(window.location.href, {
                    page: page,
                    pagesize: pagesize,
                    sort: sort,
                    filter: (0, _stringify.default)(filter),
                    search: (0, _stringify.default)(search)
                  });
    ...
    (0, _forEach2.default)(actions, function (action) {
      if (action === 'create') {
        props.create = function () {
          var _ref36 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(body) {
        ...
        props[action] = function () {
          var _ref37 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee9(body) {
        ...
        props.remove = function () {
          var _ref38 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee10(body) {
        ...
        props.order = function () {
          var _ref39 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee11(body, diff) {
...
function generateDynamicRecordsComponent(_ref40) {
  var app = _ref40.app,
      config = _ref40.config,
      _component = _ref40.component;
  ...
  return (0, _dynamic.default)({
    ...
    component: function component() {
      return _promise.default.resolve(generateRecordsPage(config, _component));
    }
  });
}

function dynamicRecordsComponent(_ref41) {
  var app = _ref41.app,
      config = _ref41.config,
      component = _ref41.component;
