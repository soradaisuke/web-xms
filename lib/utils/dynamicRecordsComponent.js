...
function generateRecordsPage(_ref18, component) {
  var _ref18$api = _ref18.api,
      host = _ref18$api.host,
      path = _ref18$api.path,
      fetchFixedFilter = _ref18$api.fetchFixedFilter,
      createDefaultBody = _ref18$api.createDefaultBody,
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    ...
    var props = {
      fetch: function () {
        var _fetch3 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee5(_ref19) {
          var page, pagesize, sort, _ref19$filter, filter, queries, uri;

          return _regenerator.default.wrap(function _callee5$(_context9) {
            while (1) {
              switch (_context9.prev = _context9.next) {
                case 0:
                  page = _ref19.page, pagesize = _ref19.pagesize, sort = _ref19.sort, _ref19$filter = _ref19.filter, filter = _ref19$filter === void 0 ? {} : _ref19$filter;
      ...
      remove: function () {
        var _remove2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(_ref20) {
          var id;
      ...
      updatePage: function () {
        var _updatePage = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref21) {
          var page, pagesize, sort, filter, newQuery, uri;
          return _regenerator.default.wrap(function _callee7$(_context11) {
            while (1) {
              switch (_context11.prev = _context11.next) {
                case 0:
                  page = _ref21.page, pagesize = _ref21.pagesize, sort = _ref21.sort, filter = _ref21.filter;
                  newQuery = {
                    page: page,
                    pagesize: pagesize,
                    sort: sort,
      ...
      create: function () {
        var _create2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(_ref22) {
          var body;
      ...
      edit: function () {
        var _edit2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee9(_ref23) {
          var id, body;
          return _regenerator.default.wrap(function _callee9$(_context13) {
            while (1) {
              switch (_context13.prev = _context13.next) {
                case 0:
                  id = _ref23.id, body = _ref23.body;
...
function generateDynamicRecordsComponent(_ref24) {
  var app = _ref24.app,
      config = _ref24.config,
      _component = _ref24.component;
...
function dynamicRecordsComponent(_ref25) {
  var app = _ref25.app,
