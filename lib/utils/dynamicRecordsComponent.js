  ...
  var filterInGroupTables = (0, _reselect.createSelector)([function (state) {
    ...
    return tables.filter(function (_ref38) {
      var type = _ref38.type,
          ...
          invisible = _ref38.invisible,
          filterTree = _ref38.filterTree;
      return canFilter && (type === _ColumnTypes.default.date || type === _ColumnTypes.default.datetime || type === _ColumnTypes.default.number || invisible || filterTree);
    });
  });
