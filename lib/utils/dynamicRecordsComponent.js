  ...
  var model = {
    ...
    effects: {
      fetch: _regenerator.default.mark(function fetch(_ref7, _ref8) {
        var _ref7$payload, page, pagesize, sort, _ref7$payload$filter, filter, params, call, put, f, _ref9, records, total;

        return _regenerator.default.wrap(function fetch$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _ref7$payload = _ref7.payload, page = _ref7$payload.page, pagesize = _ref7$payload.pagesize, sort = _ref7$payload.sort, _ref7$payload$filter = _ref7$payload.filter, filter = _ref7$payload$filter === void 0 ? {} : _ref7$payload$filter, params = _ref7$payload.params;
...
function generateRecordsPage(_ref17, Modal) {
  ...
  var mapStateToProps = function mapStateToProps(state) {
    ...
    var page = queries.page ? (0, _toInteger2.default)(queries.page) : 1;
    var pagesize = queries.pagesize ? (0, _toInteger2.default)(queries.pagesize) : 10;
    var sort = queries.sort || state[namespace].get('defaultSort');
    return {
      page: page,
      pagesize: pagesize,
      sort: sort,
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    var props = {
      fetch: function () {
        var _fetch2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee5(_ref18) {
          var page, pagesize, sort, params;
          return _regenerator.default.wrap(function _callee5$(_context9) {
            while (1) {
              switch (_context9.prev = _context9.next) {
                case 0:
                  page = _ref18.page, pagesize = _ref18.pagesize, sort = _ref18.sort, params = _ref18.params;
    ...
    if (create) {
      props.create = function () {
        var _ref21 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(body) {
    ...
    if (remove) {
      props.remove = function () {
        var _ref23 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee10(id) {
