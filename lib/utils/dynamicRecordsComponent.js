...
function generateModel(_ref11, service) {
  var namespace = _ref11.namespace,
      ...
      searchFileds = _ref11.searchFileds;
  ...
  var model = {
    ...
    effects: {
      fetch: _regenerator.default.mark(function fetch(_ref14, _ref15) {
        var _ref14$payload, path, page, pagesize, sort, search, _ref14$payload$filter, filter, call, put, i, f, _ref16, records, total;
              ...
              case 10:
                ...
                if (search) {
                  if (searchFileds.length === 1) {
                    ...
                    f.$or = searchFileds.reduce(function (acc, field) {
                      acc.push((0, _defineProperty2.default)({}, field.key, search));
                      return acc;
                    }, []);
                  }
                }
      ...
      getFilters: _regenerator.default.mark(function getFilters(_ref17, _ref18) {
        var _ref17$payload, index, filtersFunc, call, put, filters;

        return _regenerator.default.wrap(function getFilters$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _ref17$payload = _ref17.payload, index = _ref17$payload.index, filtersFunc = _ref17$payload.filtersFunc;
                call = _ref18.call, put = _ref18.put;
                _context7.next = 4;
                return call(filtersFunc);
...
function generateRecordsPage(_ref27, component) {
  var namespace = _ref27.namespace,
      ...
      searchPlaceHolder = _ref27.searchPlaceHolder,
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    ...
    var props = {
      fetch: function () {
        var _fetch2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(_ref28) {
          var page, pagesize, sort, search, _ref28$filter, filter;
      ...
      updatePage: function () {
        var _updatePage = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref29) {
          var page, pagesize, sort, search, _ref29$filter, filter, uri;

          return _regenerator.default.wrap(function _callee7$(_context13) {
            while (1) {
              switch (_context13.prev = _context13.next) {
                case 0:
                  page = _ref29.page, pagesize = _ref29.pagesize, sort = _ref29.sort, search = _ref29.search, _ref29$filter = _ref29.filter, filter = _ref29$filter === void 0 ? {} : _ref29$filter;
                  ...
                  return _context13.abrupt("return", dispatch(_router.routerRedux.push(uri.href.substring(uri.origin.length, uri.href.length))));
    ...
    (0, _forEach2.default)(actions, function (action) {
      if (action === 'create') {
        props.create = function () {
          var _ref30 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(body) {
        ...
        props.edit = function () {
          var _ref31 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee9(body) {
        ...
        props.remove = function () {
          var _ref32 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee10(body) {
        ...
        props.order = function () {
          var _ref33 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee11(body, diff) {
...
function generateDynamicRecordsComponent(_ref34) {
  var app = _ref34.app,
      config = _ref34.config,
      _component = _ref34.component;
