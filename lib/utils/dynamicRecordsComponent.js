          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", _request.default.remove("".concat((0, _split2.default)(path, '?')[0], "/").concat(id)));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return _context3.abrupt("return", _request.default.post("".concat((0, _split2.default)(path, '?')[0]), {
                  body: body
                }));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return _context4.abrupt("return", _request.default.put("".concat((0, _split2.default)(path, '?')[0], "/").concat(id), {
                  body: body
                }));
  ...
  var model = {
    ...
    effects: {
      fetch: [_regenerator.default.mark(function fetch(_ref8, _ref9) {
        var _ref8$payload, path, page, pagesize, sort, _ref8$payload$filter, filter, call, put, _ref10, records, total;

        return _regenerator.default.wrap(function fetch$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _ref8$payload = _ref8.payload, path = _ref8$payload.path, page = _ref8$payload.page, pagesize = _ref8$payload.pagesize, sort = _ref8$payload.sort, _ref8$payload$filter = _ref8$payload.filter, filter = _ref8$payload$filter === void 0 ? {} : _ref8$payload$filter;
              ...
              case 16:
                (0, _showError.default)(_context5.t0.message);
      ...
      remove: _regenerator.default.mark(function modelRemove(_ref11, _ref12) {
        var _ref11$payload, path, id, call;

        return _regenerator.default.wrap(function modelRemove$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _ref11$payload = _ref11.payload, path = _ref11$payload.path, id = _ref11$payload.id;
                call = _ref12.call;
                _context6.next = 4;
      ...
      create: _regenerator.default.mark(function modelCreate(_ref13, _ref14) {
        var _ref13$payload, path, body, call;

        return _regenerator.default.wrap(function modelCreate$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _ref13$payload = _ref13.payload, path = _ref13$payload.path, body = _ref13$payload.body;
                call = _ref14.call;
                _context7.next = 4;
      ...
      edit: _regenerator.default.mark(function modelEdit(_ref15, _ref16) {
        var _ref15$payload, path, id, body, call;

        return _regenerator.default.wrap(function modelEdit$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _ref15$payload = _ref15.payload, path = _ref15$payload.path, id = _ref15$payload.id, body = _ref15$payload.body;
                call = _ref16.call;
                _context8.next = 4;
...
function getQuery(_ref19) {
  var namespace = _ref19.namespace,
      inline = _ref19.inline,
...
function generateRecordsPage(_ref20, component, inline) {
  var _ref20$api = _ref20.api,
      host = _ref20$api.host,
      path = _ref20$api.path,
      fixedFilter = _ref20$api.fixedFilter,
      defaultBody = _ref20$api.defaultBody,
      defaultFilter = _ref20$api.defaultFilter,
      namespace = _ref20.namespace,
      actions = _ref20.actions,
      table = _ref20.table,
      _ref20$defaultPageSiz = _ref20.defaultPageSize,
      defaultPageSize = _ref20$defaultPageSiz === void 0 ? 10 : _ref20$defaultPageSiz,
      tableScroll = _ref20.tableScroll,
      filterGroupTrigger = _ref20.filterGroupTrigger,
      _ref20$tableComponent = _ref20.tableComponentProps,
      tableComponentProps = _ref20$tableComponent === void 0 ? {} : _ref20$tableComponent,
      _ref20$paginationComp = _ref20.paginationComponentProps,
      paginationComponentProps = _ref20$paginationComp === void 0 ? {} : _ref20$paginationComp;

  if (tableScroll) {
    console.error("'config.tableScroll' is deprecated, please use 'config.tableComponentProps: { scroll }'");
  }
  ...
  var mapStateToProps = function mapStateToProps(state, props) {
    ...
    return {
      ...
      pagesize: queries.pagesize ? (0, _toInteger2.default)(queries.pagesize) : defaultPageSize,
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    ...
    } else if ((0, _isPlainObject2.default)(fixedFilter)) {
    ...
    var props = {
      fetch: function () {
        var _fetch3 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee5(_ref21) {
          var page, pagesize, sort, _ref21$filter, filter, preQueries, queries, uri;

          return _regenerator.default.wrap(function _callee5$(_context9) {
            while (1) {
              switch (_context9.prev = _context9.next) {
                case 0:
                  page = _ref21.page, pagesize = _ref21.pagesize, sort = _ref21.sort, _ref21$filter = _ref21.filter, filter = _ref21$filter === void 0 ? {} : _ref21$filter;
                  preQueries = (0, _queryString.parse)(location.search);
                  queries = getQuery({
                    namespace: namespace,
                    inline: inline,
                  ...
                  uri = (0, _generateUri2.default)(window.location.href.substring(0, window.location.href.length - window.location.search.length), (0, _objectSpread2.default)({}, preQueries, generateQuery({
                    namespace: namespace,
                    inline: inline,
                    query: {
                      filter: JSON.stringify((0, _objectSpread2.default)({}, table.getDefaultFilter() || {}, apiDefaultFilter)),
      ...
      remove: function () {
        var _remove2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(_ref22) {
          var id;
      ...
      updatePage: function () {
        var _updatePage = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref23) {
          var page, pagesize, sort, filter, newFilter, newQuery, preQueries, uri;
          return _regenerator.default.wrap(function _callee7$(_context11) {
            while (1) {
              switch (_context11.prev = _context11.next) {
                case 0:
                  page = _ref23.page, pagesize = _ref23.pagesize, sort = _ref23.sort, filter = _ref23.filter;
                  newFilter = (0, _objectSpread2.default)({}, filter || {});
                  ...
                  preQueries = (0, _queryString.parse)(window.location.search);
                  uri = (0, _generateUri2.default)(window.location.href.substring(0, window.location.href.length - window.location.search.length), (0, _objectSpread2.default)({}, preQueries, generateQuery({
                    namespace: namespace,
                    inline: inline,
                    query: newQuery
      ...
      create: function () {
        var _create2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(_ref24) {
          var body;
      ...
      edit: function () {
        var _edit2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee9(_ref25) {
          var id, body;
...
function generateDynamicRecordsComponent(_ref26) {
  var app = _ref26.app,
      config = _ref26.config,
      _component = _ref26.component,
      inline = _ref26.inline;
...
function dynamicRecordsComponent(_ref27) {
  var app = _ref27.app,
      config = _ref27.config,
      component = _ref27.component,
