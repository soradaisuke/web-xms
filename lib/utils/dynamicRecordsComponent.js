...
function generateRecordsPage(_ref29, component) {
  var _ref29$api = _ref29.api,
      ...
      searchFields = _ref29.searchFields,
  ...
  var filterInGroupSchemas = (0, _reselect.createSelector)([function (state) {
    return state[namespace].get('schema');
  }], function (sche) {
    var schemas = sche.toJS();
    return schemas.filter(function (_ref33) {
      var type = _ref33.type,
          canFilter = _ref33.canFilter,
          visibility = _ref33.visibility,
          filterTree = _ref33.filterTree;
