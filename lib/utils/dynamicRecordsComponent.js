...
function generateModel(_ref5, service) {
  ...
  var model = {
    ...
    reducers: {
      ...
      saveSort: function saveSort(state, _ref7) {
        var _ref7$payload = _ref7.payload,
            key = _ref7$payload.key,
            order = _ref7$payload.order;
        return state.set('sort', _immutable.default.fromJS({
          key: key,
          order: order
        }));
      }
    ...
    effects: {
      fetch: _regenerator.default.mark(function fetch(_ref8, _ref9) {
        var _ref8$payload, _ref8$payload$page, page, _ref8$payload$pagesiz, pagesize, _ref8$payload$filter, filter, params, call, put, select, f, _ref10, sort, _ref11, records, total;
            ...
            switch (_context5.prev = _context5.next) {
              ...
              case 6:
                ...
                return call(service.fetch, {
                  ...
                  order: sort ? "".concat(sort.get('key'), " ").concat(sort.get('order')) : null
                });
      ...
      changeSort: _regenerator.default.mark(function changeSort(_ref12, _ref13) {
        var _ref12$payload, key, order, put, canSort, title;

        return _regenerator.default.wrap(function changeSort$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _ref12$payload = _ref12.payload, key = _ref12$payload.key, order = _ref12$payload.order;
                put = _ref13.put;
                canSort = false;
                (0, _forEach2.default)(schema, function (definition) {
              ...
              case 9:
                throw new Error("".concat(title, "\u4E0D\u652F\u6301").concat(order === 'asc' ? '升序' : '降序', "\u6392\u5E8F"));
  ...
  if (create) {
    model.effects.create = _regenerator.default.mark(function modelCreate(_ref14, _ref15) {
      var body, call;
  ...
  if (edit) {
    model.effects.edit = _regenerator.default.mark(function modelEdit(_ref16, _ref17) {
      var body, call;
      return _regenerator.default.wrap(function modelEdit$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              body = _ref16.payload.body;
              call = _ref17.call;
              _context8.next = 4;
  ...
  if (remove) {
    model.effects.remove = _regenerator.default.mark(function modelRemove(_ref18, _ref19) {
      var id, call;
...
function generateModal(_ref20) {
  var namespace = _ref20.namespace,
      ...
      _ref20$action = _ref20.action,
      create = _ref20$action.create,
      edit = _ref20$action.edit;
...
function generateRecordsPage(_ref21, Modal) {
  var namespace = _ref21.namespace,
      ...
      _ref21$action = _ref21.action,
      create = _ref21$action.create,
      edit = _ref21$action.edit,
      remove = _ref21$action.remove,
      orderAction = _ref21$action.order;
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    var props = {
      ...
      changeSort: function () {
        var _changeSort = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(_ref23) {
          var key, order;
          return _regenerator.default.wrap(function _callee6$(_context11) {
            while (1) {
              switch (_context11.prev = _context11.next) {
                case 0:
                  key = _ref23.key, order = _ref23.order;
                  return _context11.abrupt("return", dispatch({
                    type: "".concat(namespace, "/changeSort"),
                    payload: {
                      key: key,
                      order: order
                    }
        ...
        return function changeSort(_x6) {
    ...
    if (create) {
      props.create = function () {
        var _ref24 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(body) {
    ...
    if (edit) {
      props.edit = function () {
        var _ref25 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(body) {
    ...
    if (remove) {
      props.remove = function () {
        var _ref26 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee9(id) {
