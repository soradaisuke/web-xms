...
function generateRecordsPage(_ref25, component) {
  var namespace = _ref25.namespace,
      actions = _ref25.actions,
      _ref25$api = _ref25.api,
      path = _ref25$api.path,
      defaultFilter = _ref25$api.defaultFilter,
      primaryKey = _ref25.primaryKey,
      searchFileds = _ref25.searchFileds,
      searchPlaceHolder = _ref25.searchPlaceHolder,
      defaultSort = _ref25.defaultSort;
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    ...
    var props = {
      fetch: function () {
        var _fetch2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(_ref26) {
          var page, pagesize, sort, search, _ref26$filter, filter;

          return _regenerator.default.wrap(function _callee6$(_context11) {
            while (1) {
              switch (_context11.prev = _context11.next) {
                case 0:
                  page = _ref26.page, pagesize = _ref26.pagesize, sort = _ref26.sort, search = _ref26.search, _ref26$filter = _ref26.filter, filter = _ref26$filter === void 0 ? {} : _ref26$filter;
      ...
      updatePage: function () {
        var _updatePage = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref27) {
          var page, pagesize, sort, search, _ref27$filter, filter, uri;
    ...
    (0, _forEach2.default)(actions, function (action) {
      if (action === 'create') {
        props.create = function () {
          var _ref28 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(body) {
        ...
        props.edit = function () {
          var _ref29 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee9(body) {
        ...
        props.remove = function () {
          var _ref30 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee10(body) {
        ...
        props.order = function () {
          var _ref31 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee11(body, diff) {
...
function generateDynamicRecordsComponent(_ref32) {
  var app = _ref32.app,
      config = _ref32.config,
      _component = _ref32.component;
...
function dynamicRecordsComponent(_ref33) {
  var app = _ref33.app,
      config = _ref33.config,
      component = _ref33.component;
