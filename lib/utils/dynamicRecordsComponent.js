...
function generateRecordsPage(_ref29, component) {
  ...
  var filterInGroupSchemas = schema.filter(function (_ref33) {
    var type = _ref33.type,
        canFilter = _ref33.canFilter,
        rangeFilter = _ref33.rangeFilter,
        visibility = _ref33.visibility;
    return canFilter && (type === _ColumnTypes.default.date || type === _ColumnTypes.default.datetime || type === _ColumnTypes.default.number && rangeFilter || !(visibility && visibility.table));
  });
