  ...
  var model = {
    ...
    reducers: {
      ...
      saveModalFilters: function saveModalFilters(state, _ref15) {
        ...
        return state.set('schema', state.get('schema').setIn([index, 'modalFilters'], filters));
      },
    ...
    effects: {
      ...
      updateModalFilters: _regenerator.default.mark(function updateModalFilters(_ref22, _ref23) {
        var _ref22$payload, mapKey, formFieldsValue, call, put, index, targetSchema, filters;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                index = (0, _findIndex2.default)(schema, function (_ref24) {
                  var mk = _ref24.mapKey;
                  return mk === mapKey;
                });
                targetSchema = schema[index];

                if (!(targetSchema && (0, _isFunction2.default)(targetSchema.filters))) {
                  _context8.next = 10;
                  break;
                }

                _context8.next = 7;
                return call(targetSchema.filters, formFieldsValue);
...
function generateRecordsPage(_ref33, component) {
  ...
  var customMultipleEdits = schema.filter(function (_ref37) {
  ...
  var filterInGroupSchemas = (0, _reselect.createSelector)([function (state) {
    ...
    return schemas.filter(function (_ref38) {
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    ...
    var props = {
      fetch: function () {
        var _fetch2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(_ref39) {
