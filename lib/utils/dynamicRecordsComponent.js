  ...
  var service = {
    fetch: function () {
      var _fetch = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(_ref2) {
        var _ref2$page, page, _ref2$pagesize, pagesize;

        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _ref2$page = _ref2.page, page = _ref2$page === void 0 ? 1 : _ref2$page, _ref2$pagesize = _ref2.pagesize, pagesize = _ref2$pagesize === void 0 ? 10 : _ref2$pagesize;
  ...
  var model = {
    ...
    effects: {
      fetch: _regenerator.default.mark(function fetch(_ref11, _ref12) {
        var _ref11$payload, _ref11$payload$page, page, _ref11$payload$pagesi, pagesize, call, put, _ref13, records, total;

        return _regenerator.default.wrap(function fetch$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _ref11$payload = _ref11.payload, _ref11$payload$page = _ref11$payload.page, page = _ref11$payload$page === void 0 ? 1 : _ref11$payload$page, _ref11$payload$pagesi = _ref11$payload.pagesize, pagesize = _ref11$payload$pagesi === void 0 ? 10 : _ref11$payload$pagesi;
