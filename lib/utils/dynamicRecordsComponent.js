...
function generateModel(_ref6, service, app) {
  ...
  var model = {
    ...
    reducers: {
      ...
      saveFilters: function saveFilters(state, _ref8) {
        var _ref8$payload = _ref8.payload,
            filters = _ref8$payload.filters,
            index = _ref8$payload.index;
    ...
    effects: {
      fetch: _regenerator.default.mark(function fetch(_ref9, _ref10) {
        var _ref9$payload, page, pagesize, sort, search, _ref9$payload$filter, filter, params, call, put, f, _ref11, records, total;

        return _regenerator.default.wrap(function fetch$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _ref9$payload = _ref9.payload, page = _ref9$payload.page, pagesize = _ref9$payload.pagesize, sort = _ref9$payload.sort, search = _ref9$payload.search, _ref9$payload$filter = _ref9$payload.filter, filter = _ref9$payload$filter === void 0 ? {} : _ref9$payload$filter, params = _ref9$payload.params;
  ...
  (0, _forEach2.default)(actions, function (action) {
    if (action === 'create') {
      model.effects.create = _regenerator.default.mark(function modelCreate(_ref12, _ref13) {
        var _ref12$payload, body, params, call, newBody;

        return _regenerator.default.wrap(function modelCreate$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _ref12$payload = _ref12.payload, body = _ref12$payload.body, params = _ref12$payload.params;
                call = _ref13.call;
                newBody = body;
      ...
      model.effects.edit = _regenerator.default.mark(function modelEdit(_ref14, _ref15) {
        var body, call;
      ...
      model.effects.remove = _regenerator.default.mark(function modelRemove(_ref16, _ref17) {
        var id, call;
      ...
      model.effects.order = _regenerator.default.mark(function modelOrder(_ref18, _ref19) {
        var _ref18$payload, body, diff, call;

        return _regenerator.default.wrap(function modelOrder$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                _ref18$payload = _ref18.payload, body = _ref18$payload.body, diff = _ref18$payload.diff;
                call = _ref19.call;
                _context10.next = 4;
...
function generateRecordsPage(_ref21, modal, component) {
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    var props = {
      fetch: function () {
        var _fetch2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(_ref22) {
          var page, pagesize, sort, search, filter, params;
          return _regenerator.default.wrap(function _callee6$(_context11) {
            while (1) {
              switch (_context11.prev = _context11.next) {
                case 0:
                  page = _ref22.page, pagesize = _ref22.pagesize, sort = _ref22.sort, search = _ref22.search, filter = _ref22.filter, params = _ref22.params;
      ...
      updatePage: function () {
        var _updatePage = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref23) {
          var page, pagesize, sort, search, _ref23$filter, filter, uri;

          return _regenerator.default.wrap(function _callee7$(_context12) {
            while (1) {
              switch (_context12.prev = _context12.next) {
                case 0:
                  page = _ref23.page, pagesize = _ref23.pagesize, sort = _ref23.sort, search = _ref23.search, _ref23$filter = _ref23.filter, filter = _ref23$filter === void 0 ? {} : _ref23$filter;
    ...
    (0, _forEach2.default)(actions, function (action) {
      if (action === 'create') {
        props.create = function () {
          var _ref24 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(body, params) {
        ...
        props.edit = function () {
          var _ref25 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee9(body) {
        ...
        props.remove = function () {
          var _ref26 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee10(id) {
        ...
        props.order = function () {
          var _ref27 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee11(body, diff) {
...
function generateDynamicRecordsComponent(_ref28) {
  var app = _ref28.app,
      config = _ref28.config,
      _component = _ref28.component;
...
function dynamicRecordsComponent(_ref29) {
  var app = _ref29.app,
      config = _ref29.config,
      component = _ref29.component;
