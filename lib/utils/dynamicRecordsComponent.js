...
function generateRecordsPage(_ref33, component) {
  var _ref33$api = _ref33.api,
      ...
      fetchFixedFilter = _ref33$api.fetchFixedFilter,
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    ...
    var props = {
      fetch: function () {
        var _fetch3 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(_ref34) {
            ...
            while (1) {
              switch (_context13.prev = _context13.next) {
                case 0:
                  ...
                  if (!(table.getOrderColumn() && table.getDefaultSortOrder() !== sort || table.getDefaultSortOrder() && (!queries || Object.keys(queries).length === 0))) {
                    _context13.next = 6;
                    break;
                  }
                ...
                case 6:
                  return _context13.abrupt("return", dispatch({
                    ...
                    payload: {
                      ...
                      sort: sort,
                      search: search,
                      filter: (0, _objectSpread3.default)({}, filter, fetchApiFixedFilter),
                      path: apiPath
                    }
                  }));
      ...
      updatePage: function () {
        var _updatePage = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(_ref35) {
...
function generateDynamicRecordsComponent(_ref36) {
  var app = _ref36.app,
      config = _ref36.config,
      _component = _ref36.component;
...
function dynamicRecordsComponent(_ref37) {
  var app = _ref37.app,
      config = _ref37.config,
      component = _ref37.component;
