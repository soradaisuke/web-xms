  ...
  var model = {
    ...
    effects: {
      fetch: _regenerator.default.mark(function fetch(_ref14, _ref15) {
        var _ref14$payload, path, page, pagesize, sort, search, _ref14$payload$filter, filter, call, put, currentFiler, i, _ref16, records, total;
              ...
              case 0:
                ...
                if (search) {
                  if (searchFileds.length === 1) {
                    ...
                    currentFiler.$or = searchFileds.reduce(function (acc, field) {
