...
function generateRecordsPage(_ref21, component, inline) {
  var _ref21$api = _ref21.api,
      ...
      fixedFilter = _ref21$api.fixedFilter,
      defaultBody = _ref21$api.defaultBody,
      defaultFilter = _ref21$api.defaultFilter,
      namespace = _ref21.namespace,
      actions = _ref21.actions,
      table = _ref21.table,
      _ref21$defaultPageSiz = _ref21.defaultPageSize,
      defaultPageSize = _ref21$defaultPageSiz === void 0 ? 10 : _ref21$defaultPageSiz,
      tableScroll = _ref21.tableScroll,
      filterGroupTrigger = _ref21.filterGroupTrigger,
      _ref21$tableComponent = _ref21.tableComponentProps,
      tableComponentProps = _ref21$tableComponent === void 0 ? {} : _ref21$tableComponent,
      _ref21$paginationComp = _ref21.paginationComponentProps,
      paginationComponentProps = _ref21$paginationComp === void 0 ? {} : _ref21$paginationComp;
    ...
    var props = {
      fetch: function () {
        var _fetch3 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee5(_ref22) {
          var page, pagesize, sort, _ref22$filter, filter, preQueries, queries, uri;
