...
function generateModel(_ref11, service) {
  ...
  var model = {
    ...
    effects: {
      fetch: [_regenerator.default.mark(function fetch(_ref15, _ref16) {
        var _ref15$payload, path, page, pagesize, sort, _ref15$payload$search, search, _ref15$payload$filter, filter, call, put, currentFiler, i, _ref17, records, total;

        return _regenerator.default.wrap(function fetch$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _ref15$payload = _ref15.payload, path = _ref15$payload.path, page = _ref15$payload.page, pagesize = _ref15$payload.pagesize, sort = _ref15$payload.sort, _ref15$payload$search = _ref15$payload.search, search = _ref15$payload$search === void 0 ? {} : _ref15$payload$search, _ref15$payload$filter = _ref15$payload.filter, filter = _ref15$payload$filter === void 0 ? {} : _ref15$payload$filter;
      ...
      getFilters: _regenerator.default.mark(function getFilters(_ref18, _ref19) {
        var _ref18$payload, index, filtersFunc, currentFiler, call, put, filters;

        return _regenerator.default.wrap(function getFilters$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _ref18$payload = _ref18.payload, index = _ref18$payload.index, filtersFunc = _ref18$payload.filtersFunc, currentFiler = _ref18$payload.currentFiler;
  ...
  (0, _forEach2.default)(actions, function (action) {
    if (action === 'create') {
      model.effects.create = _regenerator.default.mark(function modelCreate(_ref20, _ref21) {
        var _ref20$payload, path, body, call;

        return _regenerator.default.wrap(function modelCreate$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _ref20$payload = _ref20.payload, path = _ref20$payload.path, body = _ref20$payload.body;
                call = _ref21.call;
                _context8.next = 4;
      ...
      model.effects.edit = _regenerator.default.mark(function modelEdit(_ref22, _ref23) {
        var _ref22$payload, path, body, call;

        return _regenerator.default.wrap(function modelEdit$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _ref22$payload = _ref22.payload, path = _ref22$payload.path, body = _ref22$payload.body;
                call = _ref23.call;
                _context9.next = 4;
      ...
      model.effects.remove = _regenerator.default.mark(function modelRemove(_ref24, _ref25) {
        var _ref24$payload, path, body, call;

        return _regenerator.default.wrap(function modelRemove$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                _ref24$payload = _ref24.payload, path = _ref24$payload.path, body = _ref24$payload.body;
                call = _ref25.call;
                _context10.next = 4;
      ...
      model.effects.order = _regenerator.default.mark(function modelOrder(_ref26, _ref27) {
        var _ref26$payload, path, body, diff, call;

        return _regenerator.default.wrap(function modelOrder$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _ref26$payload = _ref26.payload, path = _ref26$payload.path, body = _ref26$payload.body, diff = _ref26$payload.diff;
                call = _ref27.call;
                _context11.next = 4;
...
function generateRecordsPage(_ref28, component) {
  var _ref28$api = _ref28.api,
      host = _ref28$api.host,
      path = _ref28$api.path,
      defaultFilter = _ref28$api.defaultFilter,
      namespace = _ref28.namespace,
      actions = _ref28.actions,
      primaryKey = _ref28.primaryKey,
      searchFileds = _ref28.searchFileds,
      fixedSort = _ref28.fixedSort,
      defaultSort = _ref28.defaultSort,
      defaultFilterQuery = _ref28.defaultFilter;
  var customActions = actions.filter(function (action) {
    return (0, _isPlainObject2.default)(action);
  });
  var customGlobalActions = customActions.filter(function (_ref29) {
    var global = _ref29.global;
    return global;
  });
  var customMultipleActions = customActions.filter(function (_ref30) {
    var multiple = _ref30.multiple;
    return multiple;
  });
  var customRowActions = customActions.filter(function (_ref31) {
    var global = _ref31.global;
    return !global;
  });
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    ...
    var props = {
      fetch: function () {
        var _fetch2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(_ref32) {
          var page, pagesize, sort, search, _ref32$filter, filter, queries, uri;
      ...
      updatePage: function () {
        var _updatePage = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref33) {
          var page, pagesize, sort, search, _ref33$filter, filter, uri;

          return _regenerator.default.wrap(function _callee7$(_context13) {
            while (1) {
              switch (_context13.prev = _context13.next) {
                case 0:
                  page = _ref33.page, pagesize = _ref33.pagesize, sort = _ref33.sort, search = _ref33.search, _ref33$filter = _ref33.filter, filter = _ref33$filter === void 0 ? {} : _ref33$filter;
                  uri = (0, _generateUri2.default)(window.location.href, {
                    page: page,
                    pagesize: pagesize,
                    sort: sort,
    ...
    (0, _forEach2.default)(actions, function (action) {
      if (action === 'create') {
        props.create = function () {
          var _ref34 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(body) {
        ...
        props.edit = function () {
          var _ref35 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee9(body) {
        ...
        props.remove = function () {
          var _ref36 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee10(body) {
        ...
        props.order = function () {
          var _ref37 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee11(body, diff) {
...
function generateDynamicRecordsComponent(_ref38) {
  var app = _ref38.app,
      config = _ref38.config,
      _component = _ref38.component;
...
function dynamicRecordsComponent(_ref39) {
  var app = _ref39.app,
      config = _ref39.config,
      component = _ref39.component;
