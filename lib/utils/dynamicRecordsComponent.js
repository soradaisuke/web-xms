        ...
        return _regenerator.default.wrap(function modelOrder$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                body = _ref17.payload.body;
                call = _ref18.call;
                _context10.next = 4;
                return call(service.order, body);
...
function generateRecordsPage(_ref20, Modal) {
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    var props = {
          ...
          return _regenerator.default.wrap(function _callee6$(_context11) {
            while (1) {
              switch (_context11.prev = _context11.next) {
                case 0:
                  page = _ref21.page, pagesize = _ref21.pagesize, sort = _ref21.sort, search = _ref21.search, params = _ref21.params;
      ...
      changePage: function () {
        var _changePage = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref22) {
          var page, pagesize, uri;
          return _regenerator.default.wrap(function _callee7$(_context12) {
            while (1) {
              switch (_context12.prev = _context12.next) {
                case 0:
                  page = _ref22.page, pagesize = _ref22.pagesize;
        ...
        return function changePage(_x7) {
          return _changePage.apply(this, arguments);
        };
      }(),
      changeSort: function () {
        var _changeSort = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(_ref23) {
          var key, order, uri;
        ...
        return function changeSort(_x8) {
          return _changeSort.apply(this, arguments);
        };
      }(),
      changeSearch: function () {
        var _changeSearch = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee9(_ref24) {
          var search, uri;
          return _regenerator.default.wrap(function _callee9$(_context14) {
            while (1) {
              switch (_context14.prev = _context14.next) {
                case 0:
                  search = _ref24.search;
                  uri = (0, _generateUri.default)(window.location.href, {
                    search: search
                  });
                  return _context14.abrupt("return", dispatch(_router.routerRedux.push(uri.href.substring(uri.origin.length, uri.href.length))));
        ...
        return function changeSearch(_x9) {
    ...
    (0, _forEach2.default)(actions, function (action) {
      if (action === 'create') {
        props.create = function () {
          var _ref25 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee10(body) {
        ...
        props.edit = function () {
          var _ref26 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee11(body) {
        ...
        props.remove = function () {
          var _ref27 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee12(id) {
            return _regenerator.default.wrap(function _callee12$(_context17) {
              while (1) {
        ...
        props.order = function () {
          var _ref28 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee13(body) {
            return _regenerator.default.wrap(function _callee13$(_context18) {
              while (1) {
...
function generateDynamicRecordsComponent(_ref29) {
  var app = _ref29.app,
...
function dynamicRecordsComponent(_ref30) {
  var app = _ref30.app,
