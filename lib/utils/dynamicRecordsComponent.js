...
function generateRecordsPage(_ref29, component) {
  ...
  var customMultipleEdits = schema.filter(function (_ref33) {
    var multipleEdit = _ref33.multipleEdit;
    return multipleEdit;
  });
  ...
  var filterInGroupSchemas = (0, _reselect.createSelector)([function (state) {
    ...
    return schemas.filter(function (_ref34) {
      var type = _ref34.type,
          canFilter = _ref34.canFilter,
          visibility = _ref34.visibility,
          filterTree = _ref34.filterTree;
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    ...
    var props = {
      fetch: function () {
        var _fetch2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(_ref35) {
          var page, pagesize, sort, search, _ref35$filter, filter, queries, uri;
      ...
      updatePage: function () {
        var _updatePage = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref36) {
          var page, pagesize, sort, search, filter, newQuery, uri;
          return _regenerator.default.wrap(function _callee7$(_context13) {
            while (1) {
              switch (_context13.prev = _context13.next) {
                case 0:
                  page = _ref36.page, pagesize = _ref36.pagesize, sort = _ref36.sort, search = _ref36.search, filter = _ref36.filter;
                  newQuery = {
                    page: page,
                    pagesize: pagesize,
                    sort: sort,
    ...
    (0, _forEach2.default)(actions, function (action) {
      if (action === 'create') {
        props.create = function () {
          var _ref37 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(body) {
        ...
        props[action] = function () {
          var _ref38 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee9(body) {
        ...
        props.remove = function () {
          var _ref39 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee10(body) {
        ...
        props.order = function () {
          var _ref40 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee11(body, diff) {
...
function generateDynamicRecordsComponent(_ref41) {
  var app = _ref41.app,
      config = _ref41.config,
      _component = _ref41.component;
...
function dynamicRecordsComponent(_ref42) {
  var app = _ref42.app,
      config = _ref42.config,
      component = _ref42.component;
