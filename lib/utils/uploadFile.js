...
function uploadToAliyun(file, _ref) {
  ...
  var finalFileName = encodeURIComponent(fileName) || generateFileName(file);
...
function wrappedUploadFile(file, _ref4) {
  ...
  return (0, _webCommon.uploadFile)(file, {
    fileName: fileName,
    ssoToken: ssoToken
  });
}
...
function wrappedUploadImage(file, _ref5) {
  ...
  return (0, _webCommon.uploadImage)(file, {
    ssoToken: ssoToken,
    bucket: bucket,
