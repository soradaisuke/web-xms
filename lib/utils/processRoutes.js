...
var _dynamicRecordFormPage = _interopRequireDefault(require("./dynamicRecordFormPage"));
...
function processRoutes(_ref2) {
  ...
  function processRoutesInternal(rs) {
    ...
    return (rs || []).map(function (r) {
      ...
      if (config.type === 'list') {
      ...
      } else if (!!component || inlineRoutes.length > 0 || config.type === 'detail') {
        ...
        component = (0, _dynamicRecordFormPage.default)({
          app: app,
      ...
      if (useFormPage) {
        var formPageRoute = {
          ...
          config: (0, _objectSpread2.default)({}, processedConfig, {
            type: 'form'
          })
        };
