...
function isDynamicComponent(component) {
  ...
  return (0, _includes2.default)(str, 'import') || (0, _includes2.default)(str, 'Promise') || (0, _includes2.default)(str, '.then(');
}
  ...
  function processRoutesInternal(rs) {
    ...
    return (rs || []).map(function (r) {
      ...
      if (config.type === 'table') {
        ...
        component = (0, _dynamicComponents.dynamicRecordsComponent)(_objectSpread(_objectSpread({}, others), {}, {
          app: app,
          component: component,
          inline: inline,
        ...
        component = (0, _dynamicComponents.dynamicRecordComponent)(_objectSpread(_objectSpread({}, others), {}, {
          app: app,
          component: component,
          inline: inline,
          config: processedConfig
        ...
        component = (0, _dynamicComponents.dynamicRecordFormComponent)(_objectSpread(_objectSpread({}, others), {}, {
          app: app,
          inline: inline,
