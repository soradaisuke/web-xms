...
function processRoutes(_ref2) {
  ...
  function processRoutesInternal(rs) {
    ...
    return (rs || []).map(function (r) {
      ...
      if (isElement(_component)) {
        throw new Error("".concat(path, ": component can not be React.Element"));
      } else if (isComponent(_component)) {
        _component = (0, _dynamic.default)({
      ...
      } else if ((0, _isFunction2.default)(_component)) {
        _component = (0, _dynamic.default)({
      ...
      if (config.type === 'list') {
        _component = (0, _dynamicRecordsComponent.default)({
          app: app,
          component: _component,
          inline: inline,
      ...
      } else if (!!_component || config.type === 'detail') {
        _component = (0, _dynamicRecordComponent.default)({
          app: app,
          component: _component,
