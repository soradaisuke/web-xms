  ...
  function processRoutesInternal(rs) {
    ...
    return (rs || []).map(function (r) {
      ...
      var useFormPage = config.useFormPage,
          formPageConfig = config.formPageConfig;
      ...
      if (config.type === 'table') {
        ...
        component = (0, _dynamicComponents.dynamicRecordsComponent)({
          app: app,
          component: component,
          inline: inline,
          config: processedConfig
        });
      } else if (!!component || inlineRoutes.length > 0 || config.type === 'descriptions') {
        processedConfig = (0, _processSingleConfig.default)({
          config: config,
          path: path
        });
        component = (0, _dynamicComponents.dynamicRecordComponent)({
          app: app,
          component: component,
          config: processedConfig
        });
      } else if (config.type === 'form') {
        component = (0, _dynamicComponents.dynamicRecordFormComponent)({
          app: app,
      ...
      if (useFormPage) {
        var formPageRoute = {
          ...
          config: _objectSpread(_objectSpread({}, processedConfig.formPageConfig), {}, {
            type: 'form'
          })
        };
