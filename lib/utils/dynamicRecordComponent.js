...
function generateRecordPage(_ref13) {
  var _ref13$config = _ref13.config;
  _ref13$config = _ref13$config === void 0 ? {} : _ref13$config;
  var namespace = _ref13$config.namespace,
      _ref13$config$api = _ref13$config.api;
  _ref13$config$api = _ref13$config$api === void 0 ? {} : _ref13$config$api;
  var path = _ref13$config$api.path,
      host = _ref13$config$api.host,
      actions = _ref13$config.actions,
      table = _ref13$config.table,
      component = _ref13.component,
      inlineLayout = _ref13.inlineLayout;
...
function generateDynamicRecordComponent(_ref15) {
  var app = _ref15.app,
      ...
      inlineLayout = _ref15.inlineLayout;
  ...
  return (0, _dynamic.default)({
    ...
    component: function component() {
      return Promise.resolve(generateRecordPage({
        config: config,
...
function dynamicRecordComponent(_ref16) {
  var app = _ref16.app,
      ...
      inlineLayout = _ref16.inlineLayout;
