...
function generateRecordPage(_ref6) {
  var _ref6$config = _ref6.config;
  _ref6$config = _ref6$config === void 0 ? {} : _ref6$config;
  var namespace = _ref6$config.namespace,
      _ref6$config$api = _ref6$config.api;
  _ref6$config$api = _ref6$config$api === void 0 ? {} : _ref6$config$api;
  var path = _ref6$config$api.path,
      component = _ref6.component,
      inlineLayout = _ref6.inlineLayout;
...
function generateDynamicRecordComponent(_ref8) {
  var app = _ref8.app,
      ...
      inlineLayout = _ref8.inlineLayout;
...
function dynamicRecordComponent(_ref9) {
  var app = _ref9.app,
      ...
      inlineLayout = _ref9.inlineLayout;
