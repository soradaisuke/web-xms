...
function useCreate(_ref23) {
  ...
  return (0, _useEventCallback2.default)(function (_ref24) {
...
function useEdit(_ref27) {
  ...
  var dispatch = (0, _dva.useDispatch)();
  return (0, _useEventCallback2.default)(function (_ref28) {
    var id = _ref28.id,
        body = _ref28.body;
    return dispatch({
...
function useReset(_ref29) {
  ...
  var dispatch = (0, _dva.useDispatch)();
  return (0, _useEventCallback2.default)(function () {
    return dispatch({
...
function useRemove(_ref30) {
  ...
  var dispatch = (0, _dva.useDispatch)();
  return (0, _useEventCallback2.default)(function (_ref31) {
    var id = _ref31.id;
    return dispatch({
...
function generateRecordsPage(_ref32) {
  var _ref32$api = _ref32.api,
      ...
      table = _ref32.table,
      _ref32$pageProps = _ref32.pageProps,
      pageProps = _ref32$pageProps === void 0 ? {} : _ref32$pageProps,
  ...
  function Page(props) {
    ...
    var updatePage = (0, _useEventCallback2.default)(function (_ref34) {
...
function generateRecordPage(_ref35) {
  ...
  var path = _ref35$api.path,
      ...
      table = _ref35.table,
      _ref35$pageProps = _ref35.pageProps,
      pageProps = _ref35$pageProps === void 0 ? {} : _ref35$pageProps,
  ...
  function Page(props) {
    ...
    var _useMemo2 = (0, _react.useMemo)(function () {
      var q = (0, _queryString.parse)(location.search);
      return {
        queries: q
      };
    }, [location.search]),
        queries = _useMemo2.queries;

    var history = useHistory();
    var onChangeTab = (0, _useEventCallback2.default)(function (newTab) {
      var uri = (0, _webCommon.generateUri)(window.location.href.substring(0, window.location.href.length - window.location.search.length), _objectSpread(_objectSpread({}, queries), {}, {
        tab: newTab
      }));
      history.replace(uri.href.substring(uri.origin.length, uri.href.length));
    });
