...
function generateRecordFormPage(_ref36) {
  var namespace = _ref36.namespace,
      _ref36$formPageProps = _ref36.formPageProps,
      formPageProps = _ref36$formPageProps === void 0 ? {} : _ref36$formPageProps,
  ...
  function Page(props) {
    ...
    return _react.default.createElement(_PageConfigContext.default.Provider, {
      ...
      value: record
    }, _react.default.createElement(_RecordFormPage.default, (0, _extends2.default)({}, props, formPageProps, {
      actions: actions,
      table: table,
      record: record,
      fetch: fetch,
