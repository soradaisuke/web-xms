...
function generateRecordPage(_ref35, component) {
...
function generateRecordFormPage(_ref36) {
  var namespace = _ref36.namespace,
      _ref36$formPageConfig = _ref36.formPageConfig,
      formPageConfig = _ref36$formPageConfig === void 0 ? {} : _ref36$formPageConfig,
  ...
  function Page(props) {
    ...
    return _react.default.createElement(_PageConfigContext.default.Provider, {
      ...
      value: record
    }, _react.default.createElement(_RecordFormPage.default, (0, _extends2.default)({}, props, formPageConfig, {
      table: table,
      record: record,
      fetch: fetch,
      create: create,
...
function dynamicComponent(_ref37) {
  ...
  return (0, _dynamic.default)({
    ...
    component: function component() {
      return Promise.resolve(generateFunction(config, _component, inline));
    }
  });
}
...
function dynamicRecordComponent(_ref39) {
  var app = _ref39.app,
...
function dynamicRecordFormComponent(_ref40) {
  var app = _ref40.app,
