...
function processListConfig(_ref) {
  var config = _ref.config,
      path = _ref.path,
      _ref$formPageConfig = _ref.formPageConfig,
      formPageConfig = _ref$formPageConfig === void 0 ? {} : _ref$formPageConfig,
  ...
  return _objectSpread(_objectSpread({}, config), {}, {
    ...
    table: new _Table.default(columns, (0, _map2.default)(actions, function (action) {
      ...
      if (action instanceof _EditAction.default && useFormPage) {
        return action.setLink(function (record) {
          return "".concat((0, _get2.default)(record, newTable.getPrimaryKey()), "/edit");
        });
      }

      return action;
    })),
    formPageConfig: _objectSpread(_objectSpread(_objectSpread({}, config), formPageConfig), {}, {
      actions: (0, _concat2.default)((0, _filter2.default)(actions, function (action) {
        return (action instanceof _CreateAction.default || action instanceof _EditAction.default || action instanceof _DeleteAction.default) && useFormPage;
