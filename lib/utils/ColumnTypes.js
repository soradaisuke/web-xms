...
var generateTreeData = function generateTreeData(filters) {
  ...
  return (0, _map2.default)(filters, function (_ref) {
    ...
    return (0, _objectSpread2.default)({
      value: (0, _isBoolean2.default)(value) || (0, _isNumber2.default)(value) ? String(value) : value,
      key: (0, _isBoolean2.default)(value) || (0, _isNumber2.default)(value) ? String(value) : value,
      title: text,
...
var PrimitiveColumnType = function (_BaseColumnType) {
  ...
  (0, _createClass2.default)(PrimitiveColumnType, [{
      ...
      if (this.primitiveType === TYPES.NUMBER && rangeFilter) {
        ...
        return _react.default.createElement("div", null, _react.default.createElement(_inputNumber.default, {
          ...
          onChange: function onChange(v) {
            return _onChange([v, newValue[1]]);
          }
        }), "~", _react.default.createElement(_inputNumber.default, {
          value: newValue[1],
          onChange: function onChange(v) {
            return _onChange([newValue[0], v]);
          }
        }));
      }
    ...
    key: "getFormRules",
    value: function getFormRules(_ref3) {
    ...
    value: function renderFormItem(_ref4) {
      var placeholder = _ref4.placeholder,
          title = _ref4.title,
          _ref4$formItemProps = _ref4.formItemProps,
...
var BaseDateColumnType = function (_BaseColumnType2) {
  ...
  (0, _createClass2.default)(BaseDateColumnType, [{
    ...
    key: "renderFilterItem",
    value: function renderFilterItem(_ref5) {
      var _this3 = this;

      var value = _ref5.value,
          _onChange2 = _ref5.onChange,
          rangeFilter = _ref5.rangeFilter,
          filters = _ref5.filters,
          mapKey = _ref5.mapKey;
      var ranges = {};

      if (rangeFilter && filters && filters.length) {
        filters.map(function (_ref6) {
          var text = _ref6.text,
              v = _ref6.value;
      ...
      if (rangeFilter) {
        ...
        return _react.default.createElement(_datePicker.default.RangePicker, {
          ...
          onChange: function onChange(newDate) {
            return _onChange2([_this3.formatSubmitValue(newDate[0], true), _this3.formatSubmitValue(newDate[1], false)]);
          }
        });
      }
...
var DateColumnType = function (_BaseDateColumnType) {
  ...
  (0, _createClass2.default)(DateColumnType, [{
    ...
    key: "formatSubmitValue",
    value: function formatSubmitValue(v) {
      return v && (0, _isFunction2.default)(v.format) ? v.format(this.getFormat()) : v;
    }
  }, {
    key: "showTime",
    value: function showTime() {
...
var DateTimeDefaultRangeColumnType = function (_BaseDateColumnType3) {
  (0, _inherits2.default)(DateTimeDefaultRangeColumnType, _BaseDateColumnType3);

  function DateTimeDefaultRangeColumnType() {
    (0, _classCallCheck2.default)(this, DateTimeDefaultRangeColumnType);
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(DateTimeDefaultRangeColumnType).apply(this, arguments));
  }

  (0, _createClass2.default)(DateTimeDefaultRangeColumnType, [{
    key: "getName",
    value: function getName() {
      return TYPES.DATETIME;
    }
    ...
    value: function formatSubmitValue(v) {
      ...
      if (!(v && (0, _isFunction2.default)(v.toISOString))) return v;
      if (start) v.hour(0).minute(0).second(0);else v.hour(23).minute(59).second(59);
    ...
    key: "renderFilterItem",
    value: function renderFilterItem(datas) {
      return (0, _get2.default)((0, _getPrototypeOf2.default)(DateTimeDefaultRangeColumnType.prototype), "renderFilterItem", this).call(this, (0, _objectSpread2.default)({}, datas, {
        rangeFilter: true
      }));
    }
  }]);
  return DateTimeDefaultRangeColumnType;
}(BaseDateColumnType);
...
var TimeColumnType = function (_BaseColumnType3) {
  ...
  (0, _createClass2.default)(TimeColumnType, [{
    ...
    value: function renderFormItem(_ref8) {
      var _ref8$formItemProps = _ref8.formItemProps,
  ...
  (0, _createClass2.default)(ImageColumnType, [{
    ...
    value: function renderFormItem() {
      var _ref9 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          user = _ref9.user,
          tip = _ref9.tip,
          _ref9$bucket = _ref9.bucket,
          bucket = _ref9$bucket === void 0 ? '' : _ref9$bucket,
          _ref9$formItemProps = _ref9.formItemProps,
          formItemProps = _ref9$formItemProps === void 0 ? {} : _ref9$formItemProps;
...
var EnumColumnType = function (_BaseColumnType7) {
  ...
  (0, _createClass2.default)(EnumColumnType, [{
    ...
    key: "renderFilterItem",
    value: function renderFilterItem(_ref10) {
      var filters = _ref10.filters,
          value = _ref10.value,
          onChange = _ref10.onChange,
          filterMultiple = _ref10.filterMultiple,
          otherProps = (0, _objectWithoutProperties2.default)(_ref10, ["filters", "value", "onChange", "filterMultiple"]);
      return _react.default.createElement(_Select.default, (0, _extends2.default)({
        ...
        value: (0, _isBoolean2.default)(value) ? String(value) : value,
        onChange: onChange
      }, otherProps));
    }
  }, {
    ...
    value: function renderFormItem(_ref11) {
      var filters = _ref11.filters,
          _ref11$selectProps = _ref11.selectProps,
          selectProps = _ref11$selectProps === void 0 ? {} : _ref11$selectProps,
          formFieldValues = _ref11.formFieldValues;
      return _react.default.createElement(_Select.default, (0, _extends2.default)({
  ...
  (0, _createClass2.default)(UrlColumnType, [{
    ...
    value: function renderFormItem(_ref12) {
      var placeholder = _ref12.placeholder,
          title = _ref12.title,
          _ref12$formItemProps = _ref12.formItemProps,
          formItemProps = _ref12$formItemProps === void 0 ? {} : _ref12$formItemProps;
      return _react.default.createElement(_input.default, (0, _extends2.default)({
        placeholder: placeholder || "\u8BF7\u8F93\u5165".concat(title)
      }, formItemProps));
    }
...
var ArrayColumnType = function (_BaseColumnType9) {
  ...
  (0, _createClass2.default)(ArrayColumnType, [{
    ...
    key: "renderFormItem",
    value: function renderFormItem(_ref13) {
      var tip = _ref13.tip,
          max = _ref13.max,
          placeholder = _ref13.placeholder,
          enableAdd = _ref13.enableAdd,
          arrayGenerateValue = _ref13.arrayGenerateValue,
          arrayRenderValue = _ref13.arrayRenderValue,
          formItemProps = _ref13.formItemProps;
