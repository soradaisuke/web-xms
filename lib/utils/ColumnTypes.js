  ...
  (0, _createClass2.default)(PrimitiveColumnType, [{
    ...
    value: function renderFormItem(_ref) {
      var placeholder = _ref.placeholder,
          ...
          formItemProps = _ref$formItemProps === void 0 ? {} : _ref$formItemProps;
...
var DateColumnType = function (_BaseColumnType2) {
  ...
  (0, _createClass2.default)(DateColumnType, [{
    ...
    value: function renderFormItem(_ref2) {
      var _ref2$formItemProps = _ref2.formItemProps,
          formItemProps = _ref2$formItemProps === void 0 ? {} : _ref2$formItemProps;
...
var DateTimeColumnType = function (_BaseColumnType3) {
  ...
  (0, _createClass2.default)(DateTimeColumnType, [{
    ...
    value: function renderFormItem(_ref3) {
      var _ref3$formItemProps = _ref3.formItemProps,
...
var TimeColumnType = function (_BaseColumnType4) {
  (0, _inherits2.default)(TimeColumnType, _BaseColumnType4);
  ...
  function TimeColumnType() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this4)), "renderValue", function (v) {
      return (0, _isNumber2.default)(v) ? _moment.default.utc(Math.abs(_moment.default.duration(v, 's'))).format(_this4.getFormat()) : '';
    });
  ...
  (0, _createClass2.default)(TimeColumnType, [{
    ...
    key: "formatFormValue",
    value: function formatFormValue(v) {
      return (0, _isNumber2.default)(v) ? _moment.default.utc(Math.abs(_moment.default.duration(v, 's'))) : _moment.default.utc(0);
    }
  }, {
    key: "formatSubmitValue",
    value: function formatSubmitValue(v) {
      return v ? v.diff(_moment.default.utc(0), 's') : 0;
    }
  }, {
    key: "renderFormItem",
    value: function renderFormItem(_ref4) {
      var _ref4$formItemProps = _ref4.formItemProps,
          formItemProps = _ref4$formItemProps === void 0 ? {} : _ref4$formItemProps;
      return _react.default.createElement(_timePicker.default, (0, _extends2.default)({
        defaultOpenValue: _moment.default.utc(0)
      }, formItemProps));
    }
  }, {
    key: "getFormat",
...
var AudioColumnType = function (_BaseColumnType5) {
  (0, _inherits2.default)(AudioColumnType, _BaseColumnType5);
  ...
  function AudioColumnType() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this5)), "renderValue", function (v) {
...
var OrderColumnType = function (_BaseColumnType6) {
  (0, _inherits2.default)(OrderColumnType, _BaseColumnType6);
...
var ImageColumnType = function (_BaseColumnType7) {
  (0, _inherits2.default)(ImageColumnType, _BaseColumnType7);
...
var EnumColumnType = function (_BaseColumnType8) {
  (0, _inherits2.default)(EnumColumnType, _BaseColumnType8);
  ...
  (0, _createClass2.default)(EnumColumnType, [{
    ...
    value: function renderFormItem(_ref6) {
      var filters = _ref6.filters,
          _ref6$selectProps = _ref6.selectProps,
          selectProps = _ref6$selectProps === void 0 ? {} : _ref6$selectProps,
          formFieldValues = _ref6.formFieldValues;
...
var UrlColumnType = function (_BaseColumnType9) {
  (0, _inherits2.default)(UrlColumnType, _BaseColumnType9);

  function UrlColumnType() {
    var _this9;

    (0, _classCallCheck2.default)(this, UrlColumnType);
    _this9 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(UrlColumnType).call(this));
    _this9.innerColumnType = string;
    return _this9;
  }
  ...
  (0, _createClass2.default)(UrlColumnType, [{
    ...
    value: function renderFormItem(_ref7) {
      var placeholder = _ref7.placeholder,
          title = _ref7.title,
          _ref7$formItemProps = _ref7.formItemProps,
...
var ArrayColumnType = function (_BaseColumnType10) {
  (0, _inherits2.default)(ArrayColumnType, _BaseColumnType10);

  function ArrayColumnType(innerColumnType) {
    var _this10;

    (0, _classCallCheck2.default)(this, ArrayColumnType);
    _this10 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ArrayColumnType).call(this));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this10)), "renderValue", function (values) {
      return values ? (0, _join2.default)((0, _map2.default)(values, function (v) {
        return _this10.innerColumnType.renderValue(v);
      }), ',') : '';
    });
    _this10.innerColumnType = innerColumnType;
    return _this10;
  }
  ...
  (0, _createClass2.default)(ArrayColumnType, [{
    ...
    key: "renderFormItem",
    value: function renderFormItem(_ref8) {
      var tip = _ref8.tip,
          max = _ref8.max,
          placeholder = _ref8.placeholder,
          enableAdd = _ref8.enableAdd,
          arrayGenerateValue = _ref8.arrayGenerateValue,
          arrayRenderValue = _ref8.arrayRenderValue,
          formItemProps = _ref8.formItemProps;
...
var ObjectColumnType = function (_BaseColumnType11) {
  (0, _inherits2.default)(ObjectColumnType, _BaseColumnType11);

  function ObjectColumnType(innerColumnType) {
    var _this11;

    (0, _classCallCheck2.default)(this, ObjectColumnType);
    _this11 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ObjectColumnType).call(this));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this11)), "renderValue", function (values) {
      return values ? (0, _join2.default)((0, _map2.default)(values, function (v) {
