...
var PrimitiveColumnType = function (_BaseColumnType) {
  ...
  (0, _createClass2.default)(PrimitiveColumnType, [{
    ...
    key: "renderFilterItem",
    value: function renderFilterItem(_ref) {
      var rangeFilter = _ref.rangeFilter,
    ...
    value: function renderFormItem(_ref2) {
      var placeholder = _ref2.placeholder,
          title = _ref2.title,
          _ref2$formItemProps = _ref2.formItemProps,
...
var BaseDateColumnType = function (_BaseColumnType2) {
  ...
  (0, _createClass2.default)(BaseDateColumnType, [{
    ...
    key: "renderFilterItem",
    value: function renderFilterItem(_ref3) {
      var _this3 = this;

      var value = _ref3.value,
          _onChange2 = _ref3.onChange,
          rangeFilter = _ref3.rangeFilter,
    ...
    value: function renderFormItem(_ref5) {
      var _ref5$formItemProps = _ref5.formItemProps,
  ...
  (0, _createClass2.default)(ImageColumnType, [{
    ...
    value: function renderFormItem() {
      var _ref7 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          user = _ref7.user,
          tip = _ref7.tip,
          _ref7$bucket = _ref7.bucket,
          bucket = _ref7$bucket === void 0 ? '' : _ref7$bucket,
...
var EnumColumnType = function (_BaseColumnType7) {
  ...
  (0, _createClass2.default)(EnumColumnType, [{
    ...
    key: "renderFilterItem",
    value: function renderFilterItem(_ref8) {
      var filters = _ref8.filters,
          value = _ref8.value,
          onChange = _ref8.onChange,
          filterMultiple = _ref8.filterMultiple;
      return _react.default.createElement(_Select.default, {
        allowClear: true,
        mode: filterMultiple ? 'multiple' : '',
        options: (0, _map2.default)(filters, function (_ref9) {
          var v = _ref9.value,
              text = _ref9.text,
              item = (0, _objectWithoutProperties2.default)(_ref9, ["value", "text"]);
    ...
    value: function renderFormItem(_ref10) {
      ...
      return _react.default.createElement(_Select.default, (0, _extends2.default)({
        options: (0, _map2.default)(filters, function (_ref11) {
          var value = _ref11.value,
              text = _ref11.text,
              item = (0, _objectWithoutProperties2.default)(_ref11, ["value", "text"]);
          return (0, _objectSpread2.default)({
            key: value,
            children: text
          }, item);
