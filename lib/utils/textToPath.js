...
var translateSlashes = (0, _replace2.default)('/', '{slashes}');
var translatePercent = (0, _replace2.default)('%', '{percent}');
...
var _default = (0, _flow2.default)(translatePatterns, translatePercent);
