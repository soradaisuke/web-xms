...
var translateBackslash = (0, _replace2.default)(/\\/g, '{bslash}');

function translatePatterns(text) {
  var result = (0, _toString2.default)(text);
...
var _default = (0, _flow2.default)(translatePatterns, translatePercent, translateHash, translateQuestionMark, translateBackslash);
