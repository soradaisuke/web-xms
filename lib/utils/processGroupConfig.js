...
function processGroupConfig(_ref) {
  ...
  (0, _forEach2.default)(schema, function (definition) {
    ...
    if (definition.type === ORDER) {
      ...
      defaultSort = "".concat(definition.key, " asc");
    }
    ...
    if ((0, _isArray2.default)(definition.filters)) {
      (0, _forEach2.default)(definition.filters, function (_ref2) {
  ...
  return (0, _objectSpread2.default)({}, config, {
    ...
    schema: schema.map(function (definition) {
      ...
      if (type === ENUM && !filters) {
        throw new Error("".concat(path, ": ENUM\u7C7B\u578B\u5FC5\u987B\u8BBE\u7F6Efilters"));
      }
      ...
      return (0, _objectSpread2.default)({}, definition, {
        ...
        sort: sort,
        defaultSort: ds,
        enabledFilters: (0, _isArray2.default)(filters) ? (0, _filter2.default)(filters, function (_ref3) {
