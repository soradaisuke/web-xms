...
var Page = function (_React$PureComponent) {
  ...
  (0, _createClass2.default)(Page, [{
    ...
    value: function renderBackground() {
      ...
      var backgroundImage = "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' version='1.1' height='150px' width='150px'><text x='50%' y='50%' fill='rgba(0, 0, 0, 0.2)' font-size='16'>".concat(watermark, "</text></svg>\")");
