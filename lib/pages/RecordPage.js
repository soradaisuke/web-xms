...
function RecordPage(_ref) {
  ...
  var _usePageConfig = (0, _usePageConfig2.default)(),
      ...
      onChangeTab = _usePageConfig.onChangeTab,
  ...
  var routes = (0, _react.useMemo)(function () {
    return (0, _map2.default)(r, function (route) {
      return _objectSpread(_objectSpread({}, route), {}, {
        tabKey: (0, _md.default)(route.path)
      });
    });
  }, [r]);
  var renderRouteChunk = (0, _react.useCallback)(function (chunk) {
    if (chunk && chunk.length) {
      ...
      var activeKey = tab || chunk[0].tabKey;
      ...
      switch (chunkLayout) {
        ...
        case 'tab':
          return _react.default.createElement(_card.default, {
          ...
          }, (0, _map2.default)(chunk, function (_ref3) {
            var reloadOnVisible = _ref3.reloadOnVisible,
                Com = _ref3.component,
            ...
            return _react.default.createElement(TabPane, {
              tab: title,
              key: tabKey
            }, reloadOnVisible && activeKey !== tabKey ? null : _react.default.createElement(Com, {
              inline: true
            }));
          })));
  ...
  return _react.default.createElement(_Page.default, (0, _extends2.default)({}, pageProps, {
    isLoading: isLoading
