...
var RecordPage = function (_React$PureComponent) {
  ...
  var _super = _createSuper(RecordPage);
  ...
  (0, _createClass2.default)(RecordPage, [{
    ...
    value: function renderContent() {
      ...
      var _this$props4 = this.props,
          ...
          descriptionsColumn = _this$props4.descriptionsColumn;

      if (!record || !table) {
        return null;
      }

      var children = _react.default.createElement(_descriptions.default, {
        bordered: bordered,
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Page.default, {
        ...
        record: record
      })) : null, this.renderContent(), this.renderRoutes());
    }
  }]);
  return RecordPage;
...
(0, _defineProperty2.default)(RecordPage, "propTypes", {
  ...
  descriptionsColumn: _propTypes.default.oneOfType([_propTypes.default.object, _propTypes.default.number]),
