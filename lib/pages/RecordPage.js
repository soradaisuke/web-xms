  ...
  function RecordPage() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "updateRecord", function () {
      var _ref3 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee2(_ref2) {
        var promise, _ref2$loadingMessage, loadingMessage, _ref2$throwError, throwError, hide;

        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                promise = _ref2.promise, _ref2$loadingMessage = _ref2.loadingMessage, loadingMessage = _ref2$loadingMessage === void 0 ? '正在保存……' : _ref2$loadingMessage, _ref2$throwError = _ref2.throwError, throwError = _ref2$throwError === void 0 ? false : _ref2$throwError;
  ...
  (0, _createClass2.default)(RecordPage, [{
    ...
    value: function renderRoutes() {
      var _this$props5 = this.props,
          ...
          inlineLayout = _this$props5.inlineLayout,
      ...
      if (routes && routes.length) {
        switch (inlineLayout) {
          case 'collapse':
            return _react.default.createElement(_card.default, {
              className: (0, _classnames.default)('content-card', inline ? 'inline' : '')
            }, _react.default.createElement(_collapse.default, null, (0, _map2.default)(routes, function (_ref4) {
          ...
          case 'tab':
            ...
            }, (0, _map2.default)(routes, function (_ref5) {
          ...
          case 'card':
          default:
            return (0, _map2.default)(routes, function (_ref6) {
