...
var RecordPage = function (_React$PureComponent) {
  ...
  function RecordPage() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onChangeTabs", function () {
  ...
  (0, _createClass2.default)(RecordPage, [{
    ...
    value: function renderRoutes() {
      var _this$props = this.props,
          ...
          inlineWidgetType = _this$props.inlineWidgetType;

      if (routes && routes.length) {
        switch (inlineWidgetType) {
          case 'collapse':
            return _react.default.createElement(_collapse.default, null, (0, _map2.default)(routes, function (_ref) {
          ...
          case 'card':
            return (0, _map2.default)(routes, function (_ref2) {
          ...
          case 'tabs':
            ...
            }, (0, _map2.default)(routes, function (_ref3) {
          ...
          case 'stack':
          default:
            return (0, _map2.default)(routes, function (_ref4) {
              ...
              return _react.default.createElement(_react.default.Fragment, {
                key: path
              }, _react.default.createElement(_divider.default, null, title), _react.default.createElement(Component, null));
            });
        }
      }
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Page.default, {
        isLoading: isLoading,
        isError: isError
      }, Component ? _react.default.createElement(Component, null) : null, routes && routes.length && _react.default.createElement(_divider.default, null), this.renderRoutes());
    }
  }]);
  return RecordPage;
...
(0, _defineProperty2.default)(RecordPage, "propTypes", {
  ...
  inlineWidgetType: _propTypes.default.oneOf(['stack', 'tabs', 'collapse'])
});
