    ...
    value: function renderDateFilters() {
      ...
      return dateFilterSchemas.map(function (_ref20) {
        ...
        return _react.default.createElement("div", {
          ...
          defaultValue: (0, _has2.default)(filter, mapKey) && (0, _isArray2.default)(filter[mapKey]) && (0, _moment.default)(filter[mapKey][0]).isValid() && (0, _moment.default)(filter[mapKey][1]).isValid() ? [(0, _moment.default)(filter[mapKey][0]), (0, _moment.default)(filter[mapKey][1])] : [],
          ranges: ranges,
          onChange: function onChange(newDate) {
            return _this9.onChangeDateFilter(mapKey, newDate);
          }
        }) : _react.default.createElement(_DatePickerWithPresets.default, {
          defaultValue: (0, _has2.default)(filter, mapKey) && (0, _moment.default)(filter[mapKey]).isValid() ? (0, _moment.default)(filter[mapKey]) : null,
          showTime: type === DATETIME,
          format: type === DATETIME ? 'YYYY-MM-DD HH:MM:SS' : 'YYYY-MM-DD',
          presets: filters,
          onChange: function onChange(newDate) {
