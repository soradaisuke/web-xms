  ...
  (0, _createClass2.default)(RecordsPage, [{
        ...
        return _react.default.createElement(_row.default, {
          ...
          return _react.default.createElement(_col.default, {
            ...
            onChange: function onChange(value) {
              ...
              if ((0, _isFunction2.default)(definition.autoCompleteRequest)) {
                _this6.onAutoCompleteInputChange({
                  value: value,
    ...
    value: function renderActionGroup() {
      ...
      return _react.default.createElement(_Group.default, {
        ...
        }), customMultipleEdits.map(function (_ref23, index) {
          var title = _ref23.title,
              mapKey = _ref23.mapKey;
          return _react.default.createElement(_col.default, {
            span: 4,
            key: title || index
