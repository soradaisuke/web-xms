  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    value: function () {
      var _fetch = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee4() {
        var _this$props4, fetch, page, pagesize, sort, params;

        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _this$props4 = this.props, fetch = _this$props4.fetch, page = _this$props4.page, pagesize = _this$props4.pagesize, sort = _this$props4.sort, params = _this$props4.match.params;
                this.setState({
                  isLoading: true
                });
                _context4.prev = 2;
