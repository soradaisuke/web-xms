...
var RecordsPage = function (_React$PureComponent) {
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    value: function renderExpandFilters(column) {
      ...
      var options = filters ? filters.map(function (_ref4) {
      ...
      return _react.default.createElement(_row.default, {
        ...
        value: fixedFilterValue,
        label: '全部'
      }].concat((0, _toConsumableArray2.default)(options)).map(function (_ref5) {
    ...
    value: function renderFilterGroup() {
      ...
      var renderFilterGroupTable = function renderFilterGroupTable(filterColumns) {
        return _react.default.createElement(_table.default, {
          ...
          onChange: function onChange(pagination, filters, sorter) {
            return _this5.onChange(pagination, filters, sorter, columns, true);
          },
          scroll: {}
      ...
      if ((0, _size2.default)(groupedColumns) === 1) {
        return renderFilterGroupTable(groupedColumns[_Column.DEFAULT_GROUP_NAME]);
      }

      return (0, _map2.default)(groupedColumns, function (iColumns, groupName) {
        return _react.default.createElement(_row.default, {
          key: groupName,
          type: "flex"
    ...
    value: function renderContent() {
      ...
      var _this$props12 = this.props,
          ...
          tableScroll = _this$props12.tableScroll,
          tableComponentProps = _this$props12.tableComponentProps,
          paginationComponentProps = _this$props12.paginationComponentProps;
      ...
      return _react.default.createElement(_react.default.Fragment, null, this.renderGlobalActions(multipleActions), _react.default.createElement(_Group.default, {
        ...
        pagination: false,
        onChange: function onChange(pagination, filters, sorter) {
          return _this9.onChange(pagination, filters, sorter, columns);
        }
