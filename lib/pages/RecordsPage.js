...
var RecordsPage = function (_React$PureComponent) {
  ...
  function RecordsPage() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onSearch", function (_ref, value) {
      ...
      updatePage({
        ...
        sort: sort,
        filter: filter,
        search: (0, _defineProperty2.default)({}, searchKey, searchValue)
      });
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onChange", function () {
      var _ref2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(pagination, filters, sorter) {
        var _this$props3, schema, page, pagesize, search, updatePage, sort, filter, _ref3, schemaSort, newSort, newFilter, newPage;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _ref3 = (0, _find2.default)(schema, {
                  mapKey: sorter.columnKey
                }) || {}, schemaSort = _ref3.sort;
                ...
                if (schemaSort && sorter && sorter.columnKey && sorter.order) {
                  if (schemaSort[sorter.order.replace('end', '')]) {
                    ...
                    newSort = "".concat(sorter.columnKey, " asc");
                  } else if (schemaSort.desc) {
                    newSort = "".concat(sorter.columnKey, " desc");
                  } else {
                    newSort = '';
                  }
                } else {
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                _context8.next = 3;
                return _this.updateRecord({
                  promise: (0, _get2.default)(body, primaryKey) && edit ? edit(body) : create(body),
                  throwError: true
                });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "getRowKey", function (record) {
      var primaryKey = _this.props.primaryKey;
      return (0, _get2.default)(record, primaryKey);
    });
    return _this;
  }
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    value: function renderColumn(_ref14) {
      ...
      var filteredValue = (0, _has2.default)(filter, mapKey) ? String(filter[mapKey]) : '';
      ...
      if (visibility.table) {
        ...
        if (link) {
          ...
          _render = function render(value) {
            ...
            return _react.default.createElement("span", null, date.isValid() ? date.format('YYYY-MM-DD') : '');
          };
        } else if (type === IMAGE) {
          _render = function render(value) {
    ...
    value: function renderCustomRowActions(record) {
      ...
      return customRowActions.map(function (_ref15) {
    ...
    value: function renderCustomMultipleActions() {
      ...
      return customMultipleActions.map(function (_ref16) {
    ...
    value: function renderCustomGlobalActions() {
      ...
      return customGlobalActions.map(function (_ref17) {
