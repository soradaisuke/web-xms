  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    value: function renderFilterGroup() {
      ...
      if ((0, _size2.default)(groupedColumns) === 1) {
        resultComponents.push(renderFilterGroupTable(groupedColumns[_Column.DEFAULT_GROUP_NAME]));
      } else {
        resultComponents = (0, _map2.default)(groupedColumns, function (iColumns, groupName) {
          return _react.default.createElement(_row.default, {
            key: groupName,
            type: "flex"
      ...
      if (filterGroupTrigger) {
        resultComponents.push(_react.default.createElement(_button.default, {
          type: "primary",
          style: {
            marginBottom: '0.5rem'
          },
