...
var RecordsPage = function (_React$PureComponent) {
  ...
  function RecordsPage() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                filter = (0, _reduce2.default)(schema, function (acc, _ref2) {
                  var key = _ref2.key,
                      type = _ref2.type,
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onOrderChange", function () {
      var _ref3 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee2(body, diff) {
        var order;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onConfirmRemove", function () {
      var _ref4 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee3(record) {
        var remove;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onCustomRowAction", function () {
      var _ref5 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee4(record, handler) {
        var matchParams;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onCustomMultipleAction", function () {
      var _ref6 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee5(handler, enable) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onCustomGlobalAction", function () {
      var _ref7 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(handler) {
        var matchParams;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "updateRecord", function () {
      var _ref9 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref8) {
        var promise, _ref8$loadingMessage, loadingMessage, _ref8$throwError, throwError, hide;

        return _regenerator.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                promise = _ref8.promise, _ref8$loadingMessage = _ref8.loadingMessage, loadingMessage = _ref8$loadingMessage === void 0 ? '正在保存……' : _ref8$loadingMessage, _ref8$throwError = _ref8.throwError, throwError = _ref8$throwError === void 0 ? false : _ref8$throwError;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "editRecord", function () {
      var _ref10 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(body) {
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    key: "renderColumn",
    value: function renderColumn(_ref12) {
      var visibility = _ref12.visibility,
          link = _ref12.link,
          title = _ref12.title,
          key = _ref12.key,
          sort = _ref12.sort,
          filterKey = _ref12.filterKey,
          type = _ref12.type,
          imageSize = _ref12.imageSize,
          renderValue = _ref12.renderValue,
          filters = _ref12.filters,
          canFilter = _ref12.canFilter;
    ...
    value: function renderCustomRowActions(record) {
      ...
      return customRowActions.map(function (_ref13) {
    ...
    value: function renderCustomMultipleActions() {
      ...
      return customMultipleActions.map(function (_ref14) {
    ...
    value: function renderCustomGlobalActions() {
      ...
      return customGlobalActions.map(function (_ref15) {
        var title = _ref15.title,
            type = _ref15.type,
            handler = _ref15.handler,
            render = _ref15.render;
    ...
    value: function renderContent() {
      ...
      var _this$props11 = this.props,
          total = _this$props11.total,
          page = _this$props11.page,
          pagesize = _this$props11.pagesize,
          primaryKey = _this$props11.primaryKey,
          schema = _this$props11.schema,
          search = _this$props11.search,
          searchPlaceHolder = _this$props11.searchPlaceHolder,
          canSearch = _this$props11.canSearch,
          customMultipleActions = _this$props11.customMultipleActions,
          customGlobalActions = _this$props11.customGlobalActions;
      var rowSelection = customMultipleActions.length > 0 ? {
        selectedRowKeys: selectedRowKeys,
        onChange: this.onSelectChange
      } : null;
      var hasHeader = this.hasAddButton() || canSearch || customMultipleActions.length > 0 || customGlobalActions.length > 0;
      ...
      }, canSearch && _react.default.createElement(Search, {
        defaultValue: search,
