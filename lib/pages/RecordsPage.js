...
var RecordsPage = function (_React$PureComponent) {
  ...
  function RecordsPage() {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.prev = 3;
                _context4.next = 6;
                return handler(record, matchParams);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onCustomRowAction", function () {
      var _ref5 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee5(handler, enable) {
        var matchParams, selectedRows, hide;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.prev = 4;
                _context5.next = 7;
                return Promise.all((0, _map2.default)(selectedRows, function (record) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "editRecord", function () {
      var _ref6 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(body) {
        var _this$props4, edit, create, hide;
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    key: "checkSort",
    value: function checkSort(_ref7) {
      var key = _ref7.key,
          order = _ref7.order;
    ...
    key: "fetch",
    value: function () {
      var _fetch = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7() {
        ...
        return _regenerator.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _this$props6 = this.props, fetch = _this$props6.fetch, page = _this$props6.page, pagesize = _this$props6.pagesize, sort = _this$props6.sort, search = _this$props6.search, filter = _this$props6.filter;
                this.setState({
                  isLoading: true
                });
                _context7.prev = 2;
    ...
    value: function renderColumn(_ref8) {
      var visibility = _ref8.visibility,
          ...
          renderValue = _ref8.renderValue,
          filters = _ref8.filters,
          canFilter = _ref8.canFilter;
    ...
    value: function renderActions() {
      ...
      return edit || remove || customActions.length > 0 ? _react.default.createElement(Column, {
        ...
        render: function render(text, record) {
          ...
          })), customActions.map(function (_ref9) {
    ...
    value: function renderContent() {
      ...
      var rowActions = customActions ? (0, _filter2.default)(customActions, function (_ref10) {
        var rowSelection = _ref10.rowSelection;
        return rowSelection;
      }) : [];
      ...
      return _react.default.createElement(_react.default.Fragment, null, this.hasHeader() && _react.default.createElement("div", {
        ...
        className: "xms-records-page-content-header"
      }, rowActions.map(function (_ref11) {
