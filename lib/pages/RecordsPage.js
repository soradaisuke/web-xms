...
var _zipObjectDeep2 = _interopRequireDefault(require("lodash/zipObjectDeep"));
...
var RecordsPage = function (_React$PureComponent) {
  ...
  function RecordsPage(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onSearch", function (_ref, value) {
      ...
      var search = searchValue || searchValue === 0 ? (0, _zipObjectDeep2.default)([mapKey], [value]) : {};
      updatePage({
        page: 1,
        pagesize: pagesize,
        sort: sort,
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onChange", function () {
      var _ref2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(pagination, filters, sorter) {
        var _this$props3, schema, page, pagesize, search, updatePage, sort, filter, filterInGroupSchemaKeys, targetSchema, schemaSort, newSort, newFilter, newPage;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                filterInGroupSchemaKeys = _this.state.filterInGroupSchemaKeys;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onAutoCompleteInputChange", (0, _debounce2.default)(function (_ref9) {
      var value = _ref9.value,
          autoCompleteRequest = _ref9.autoCompleteRequest,
          mapKey = _ref9.mapKey;
      autoCompleteRequest(value, function (newOptions) {
        return _this.setState({
          searchOptions: (0, _defineProperty2.default)({}, mapKey, newOptions)
        });
      });
    }, 400));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "changeAutoCompleteInputSearch", function (_ref10) {
      var definition = _ref10.definition,
          value = _ref10.value;

      _this.setState({
        inputSearch: (0, _defineProperty2.default)({}, definition.mapKey, value)
      });

      _this.onAutoCompleteInputChange({
        value: value,
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "updateRecord", function () {
      var _ref12 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref11) {
        var promise, _ref11$loadingMessage, loadingMessage, _ref11$throwError, throwError, hide;

        return _regenerator.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                promise = _ref11.promise, _ref11$loadingMessage = _ref11.loadingMessage, loadingMessage = _ref11$loadingMessage === void 0 ? '正在保存……' : _ref11$loadingMessage, _ref11$throwError = _ref11.throwError, throwError = _ref11$throwError === void 0 ? false : _ref11$throwError;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "editRecord", function () {
      var _ref13 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(body) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onClickQuery", function () {
      ...
      (0, _forEach2.default)(filterGroup, function (v, key) {
        var isValid = function isValid(value) {
          return (0, _isBoolean2.default)(value) || (0, _isNumber2.default)(value) || value;
        };
        ...
        if ((0, _isArray2.default)(v) && !hasValidValue(v) || !isValid(v)) {
          delete filterGroup[key];
        }
      });
      updatePage({
        filter: (0, _objectSpread5.default)({}, filter, filterGroup)
      });
    });
    ...
    var _filterGroup = {};
    var _filterInGroupSchemaKeys = {};
    (0, _forEach2.default)(filterInGroupSchemas, function (_ref15) {
      var mapKey = _ref15.mapKey;
      _filterInGroupSchemaKeys[mapKey] = true;
    ...
    _this.state = {
      ...
      filterInGroupSchemaKeys: _filterInGroupSchemaKeys,
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    key: "renderColumn",
    value: function renderColumn(_ref16) {
      var _this2 = this;

      var visibility = _ref16.visibility,
          link = _ref16.link,
          title = _ref16.title,
          key = _ref16.key,
          sort = _ref16.sort,
          mapKey = _ref16.mapKey,
          width = _ref16.width,
          type = _ref16.type,
          imageSize = _ref16.imageSize,
          renderValue = _ref16.renderValue,
          filters = _ref16.filters,
          enabledFilters = _ref16.enabledFilters,
          canFilter = _ref16.canFilter,
          fixed = _ref16.fixed,
          inlineEdit = _ref16.inlineEdit,
          formConfig = _ref16.form,
          _ref16$filterMultiple = _ref16.filterMultiple,
          filterMultiple = _ref16$filterMultiple === void 0 ? false : _ref16$filterMultiple,
          filterTree = _ref16.filterTree;
      var _this$props10 = this.props,
          currentSort = _this$props10.sort,
            ...
            return _react.default.createElement(_input.default.TextArea, {
              ...
              onBlur: function onBlur() {
                var _ref17 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
                    relatedTarget = _ref17.relatedTarget,
                    _ref17$target = _ref17.target;

                _ref17$target = _ref17$target === void 0 ? {} : _ref17$target;
                var editValue = _ref17$target.value;
    ...
    value: function renderCustomRowActions(record) {
      ...
      return customRowActions.map(function (_ref19) {
    ...
    value: function renderSearchGroup() {
      ...
      var _this$state2 = this.state,
          inputSearch = _this$state2.inputSearch,
          searchOptions = _this$state2.searchOptions;
      ...
      return _react.default.createElement(_Group.default, {
        ...
        return _react.default.createElement(_row.default, {
          ...
          }, (0, _isFunction2.default)(definition.autoCompleteRequest) ? _react.default.createElement(_autoComplete.default, {
            defaultActiveFirstOption: false,
            style: {
              width: '100%'
            },
            dataSource: RecordsPage.renderAutoCompleteOptions(searchOptions[definition.mapKey]),
            onChange: function onChange(value) {
              return _this6.changeAutoCompleteInputSearch({
    ...
    value: function renderFilterGroup() {
      ...
      return _react.default.createElement(_Group.default, {
        title: "\u7B5B\u9009"
      }, filterInGroupSchemas.map(function (_ref21) {
        var mapKey = _ref21.mapKey,
            type = _ref21.type,
            title = _ref21.title,
            definition = (0, _objectWithoutProperties2.default)(_ref21, ["mapKey", "type", "title"]);
        return _react.default.createElement(_row.default, {
          type: "flex",
          align: "middle",
          ...
          onChange: function onChange(v) {
            _this7.setState({
              filterGroup: (0, _objectSpread5.default)({}, filterGroup, (0, _defineProperty2.default)({}, mapKey, type.formatSubmitValue(v)))
            });
          }
        }))));
    ...
    value: function renderActionGroup() {
      ...
      return _react.default.createElement(_Group.default, {
        ...
        return _react.default.createElement(_row.default, {
          gutter: 20,
          key: (0, _join2.default)((0, _map2.default)(groupActions, function (_ref22) {
            var title = _ref22.title;
            return title;
          }))
        }, groupActions.map(function (_ref23, index) {
          var createNew = _ref23.createNew,
              crt = _ref23.create,
              global = _ref23.global,
              render = _ref23.render,
              title = _ref23.title,
              type = _ref23.type,
              handler = _ref23.handler,
              multiple = _ref23.multiple,
              confirmModal = _ref23.confirmModal,
              enable = _ref23.enable;
          var children;
        ...
        }), customMultipleEdits.map(function (_ref24, index) {
          var title = _ref24.title,
              mapKey = _ref24.mapKey;
          return _react.default.createElement(_col.default, {
            span: 4,
            key: title || index
            ...
            onOk: function onOk(data) {
              return _this8.onCustomMultipleAction(function (record) {
                return _this8.editRecord((0, _objectSpread5.default)({}, record, data));
              });
            }
          }, _react.default.createElement(_button.default, {
            type: "primary",
    ...
    key: "renderAutoCompleteOptions",
    value: function renderAutoCompleteOptions(options) {
      if (!(0, _isArray2.default)(options)) return null;
      return options.map(function (option) {
        return (0, _isString2.default)(option) ? _react.default.createElement(_autoComplete.default.Option, {
          key: option,
          text: option,
          value: option
