...
var RecordsPage = function (_React$PureComponent) {
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    key: "checkSort",
    value: function checkSort(_ref4) {
      var key = _ref4.key,
          order = _ref4.order;
    ...
    value: function () {
      var _fetch = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee4() {
        var _this$props4, fetch, page, pagesize, sort, search, params;

        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _this$props4 = this.props, fetch = _this$props4.fetch, page = _this$props4.page, pagesize = _this$props4.pagesize, sort = _this$props4.sort, search = _this$props4.search, params = _this$props4.match.params;
                this.setState({
                  isLoading: true
                });
                _context4.prev = 2;
    ...
    value: function renderContent() {
      ...
      var _this$props6 = this.props,
          ...
          canSearch = _this$props6.canSearch;
