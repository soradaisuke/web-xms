  ...
  function RecordsPage(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "updateRecord", function () {
      var _ref2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(_ref) {
        var promise, _ref$loadingMessage, loadingMessage, _ref$throwError, throwError, _ref$reload, reload, hide;

        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                promise = _ref.promise, _ref$loadingMessage = _ref.loadingMessage, loadingMessage = _ref$loadingMessage === void 0 ? '正在保存……' : _ref$loadingMessage, _ref$throwError = _ref.throwError, throwError = _ref$throwError === void 0 ? false : _ref$throwError, _ref$reload = _ref.reload, reload = _ref$reload === void 0 ? false : _ref$reload;
