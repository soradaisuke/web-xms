...
var RecordsPage = function (_React$PureComponent) {
  ...
  function RecordsPage() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "updateRecord", function () {
      var _ref8 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(_ref7) {
        var promise, _ref7$loadingMessage, loadingMessage, _ref7$throwError, throwError, hide;

        return _regenerator.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                promise = _ref7.promise, _ref7$loadingMessage = _ref7.loadingMessage, loadingMessage = _ref7$loadingMessage === void 0 ? '正在保存……' : _ref7$loadingMessage, _ref7$throwError = _ref7.throwError, throwError = _ref7$throwError === void 0 ? false : _ref7$throwError;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "editRecord", function () {
      var _ref9 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(body) {
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    key: "renderColumn",
    value: function renderColumn(_ref11) {
      var visibility = _ref11.visibility,
          link = _ref11.link,
          title = _ref11.title,
          key = _ref11.key,
          sort = _ref11.sort,
          filterKey = _ref11.filterKey,
          type = _ref11.type,
          imageSize = _ref11.imageSize,
          renderValue = _ref11.renderValue,
          filters = _ref11.filters,
          canFilter = _ref11.canFilter;
    ...
    value: function renderActions() {
      ...
      return edit || remove || customActions.length > 0 ? _react.default.createElement(Column, {
        ...
        render: function render(text, record) {
          ...
          })), customActions.map(function (_ref12) {
    ...
    value: function renderContent() {
      ...
      var rowActions = customActions ? (0, _filter2.default)(customActions, function (_ref13) {
        var rowSelection = _ref13.rowSelection;
        return rowSelection;
      }) : [];
      ...
      return _react.default.createElement(_react.default.Fragment, null, this.hasHeader() && _react.default.createElement("div", {
        ...
        className: "xms-records-page-content-header"
      }, rowActions.map(function (_ref14) {
