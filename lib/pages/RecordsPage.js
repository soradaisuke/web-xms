...
var RecordsPage = function (_React$PureComponent) {
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    value: function renderColumn(_ref15) {
      ...
      var filteredValue = type.canUseColumnFilter() && filter[mapKey] ? filter[mapKey] : [];
      ...
      if (visibility.table) {
        ...
        var filterProps = canFilter && (0, _isArray2.default)(enabledFilters) && enabledFilters.length > 0 ? {
          ...
          filtered: (0, _isArray2.default)(filteredValue) ? !!filteredValue.length : !!filteredValue,
          filteredValue: (0, _isArray2.default)(filteredValue) ? filteredValue : [filteredValue],
