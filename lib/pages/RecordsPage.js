...
var RecordsPage = function (_React$PureComponent) {
  ...
  function RecordsPage(props) {
      ...
      columns.forEach(function (column) {
        if (isChangeTriggeredFilter || column.shouldRenderTableFilter()) {
          ...
          if (column.parentColumn) {
            ...
            if (!(0, _isEqual2.default)(parentFilteredValue, (0, _get2.default)(isChangeTriggeredFilter ? pendingFilter : filter, column.parentColumn.getTableFilterKey()))) {
              return true;
            }
          }
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onChangeSelectedCustomizeMap", function (selectedCustomizeMap) {
      _this.setState({
    ...
    _this.state = {
      ...
      selectedRows: [],
      defaultTableScroll: props.table.getScrollWidth() > 0 ? {
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var selectedCustomizeMap = this.state.selectedCustomizeMap;
      ...
      if (prevState.selectedCustomizeMap !== selectedCustomizeMap) {
        table.calculateScrollWidth({
          user: user,
          selectedCustomizeMap: selectedCustomizeMap
        });
        this.setState({
          defaultTableScroll: table.getScrollWidth() > 0 ? {
    ...
    value: function renderColumn(column) {
      ...
      var _this$state = this.state,
          pendingFilter = _this$state.pendingFilter,
          selectedCustomizeMap = _this$state.selectedCustomizeMap;
    ...
    value: function renderContent() {
      ...
      var _this$state2 = this.state,
          ...
          selectedCustomizeMap = _this$state2.selectedCustomizeMap,
          defaultTableScroll = _this$state2.defaultTableScroll;
