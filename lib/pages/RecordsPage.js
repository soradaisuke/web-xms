  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    value: function renderColumn(_ref7) {
      ...
      if (visibility.table) {
        ...
        var filterProps = (0, _isArray2.default)(filters) && filters.length > 0 ? {
    ...
    value: function renderActions() {
      ...
      return edit || remove || customActions.length > 0 ? _react.default.createElement(Column, {
        ...
        render: function render(text, record) {
          return _react.default.createElement("span", null, edit && _react.default.createElement(_RecordModal.default, {
            schema: schema,
            record: record,
