...
var RecordsPage = function (_React$PureComponent) {
  ...
  function RecordsPage(props) {
    ...
    (0, _forEach2.default)(filterInGroupSchemas, function (_ref13) {
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    value: function renderColumn(_ref14) {
      ...
      var visibility = _ref14.visibility,
          ...
          _ref14$filterMultiple = _ref14.filterMultiple,
          filterMultiple = _ref14$filterMultiple === void 0 ? false : _ref14$filterMultiple,
          filterTree = _ref14.filterTree;
    ...
    value: function renderSearchGroup() {
      ...
      return _react.default.createElement(_Group.default, {
        ...
        return _react.default.createElement(_row.default, {
          gutter: 20,
          key: (0, _join2.default)((0, _map2.default)(definitions, function (_ref18) {
            var mapKey = _ref18.mapKey;
            return mapKey;
          }))
    ...
    value: function renderFilterGroup() {
      ...
      return _react.default.createElement(_Group.default, {
        title: "\u7B5B\u9009"
      }, filterInGroupSchemas.map(function (_ref19) {
        var mapKey = _ref19.mapKey,
            type = _ref19.type,
            title = _ref19.title,
            definition = (0, _objectWithoutProperties2.default)(_ref19, ["mapKey", "type", "title"]);
        return _react.default.createElement(_row.default, {
          type: "flex",
          align: "middle",
    ...
    value: function renderActionGroup() {
      ...
      return _react.default.createElement(_Group.default, {
        ...
        return _react.default.createElement(_row.default, {
          gutter: 20,
          key: (0, _join2.default)((0, _map2.default)(groupActions, function (_ref20) {
            var title = _ref20.title;
            return title;
          }))
        }, groupActions.map(function (_ref21, index) {
          var createNew = _ref21.createNew,
              crt = _ref21.create,
              global = _ref21.global,
              render = _ref21.render,
              title = _ref21.title,
              type = _ref21.type,
              handler = _ref21.handler,
              multiple = _ref21.multiple,
              confirmModal = _ref21.confirmModal,
              enable = _ref21.enable;
          var children;
        ...
        }), customMultipleEdits.map(function (_ref22, index) {
          var title = _ref22.title,
              mapKey = _ref22.mapKey;
          return _react.default.createElement(_col.default, {
            span: 4,
            key: title || index
