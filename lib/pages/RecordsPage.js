...
function RecordsPage(_ref) {
  ...
  var rowActions = (0, _react.useMemo)(function () {
    return table.getRowActions().filter(function (a) {
  ...
  return _react.default.createElement(_Page.default, null, Component ? _react.default.createElement(_card.default, {
