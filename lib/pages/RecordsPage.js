...
var _generateTreeData = _interopRequireDefault(require("../../lib/utils/generateTreeData"));
...
var RecordsPage = function (_React$PureComponent) {
  ...
  function RecordsPage(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onChange", function (_ref) {
      var filters = _ref.filters,
          ...
          _ref$useFilterKey = _ref.useFilterKey,
          useFilterKey = _ref$useFilterKey === void 0 ? false : _ref$useFilterKey,
      ...
      columns.forEach(function (column) {
        if (isChangeTriggeredFilter || column.shouldRenderTableFilter() || !isChangeTriggeredFilter && column.shouldRenderOutsideFilter()) {
          (0, _unset2.default)(newFilter, column.getTableFilterKey());

          if (column.parentColumn) {
            var parentFilteredValue = filters[useFilterKey ? column.parentColumn.getTableFilterKey() : column.parentColumn.getKey()];
          ...
          var value = filters[useFilterKey ? column.getTableFilterKey() : column.getKey()];
          ...
          if (value && value.length > 0) {
            if (column.canFilterMultipleInTable()) {
              if ((0, _filter2.default)(value, function (v) {
                ...
                (0, _set2.default)(newFilter, column.getTableFilterKey(), (0, _map2.default)(value, function (v) {
                  return column.formatFormSubmitValue(v);
                }));
              }
            } else if (!(0, _isUndefined2.default)(value[0]) && !(0, _isNull2.default)(value[0])) {
              (0, _set2.default)(newFilter, column.getTableFilterKey(), column.formatFormSubmitValue(value[0]));
            }
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    key: "renderColumn",
    value: function renderColumn(_ref5) {
      var _this2 = this;

      var column = _ref5.column,
          columns = _ref5.columns,
          _ref5$shouldRenderTab = _ref5.shouldRenderTableFilter,
          shouldRenderTableFilter = _ref5$shouldRenderTab === void 0 ? true : _ref5$shouldRenderTab,
          _ref5$renderFilterInT = _ref5.renderFilterInTitle,
          renderFilterInTitle = _ref5$renderFilterInT === void 0 ? false : _ref5$renderFilterInT;
      ...
      return _react.default.createElement(Column, (0, _extends2.default)({}, renderFilterInTitle ? {} : filterProps, {
        title: renderFilterInTitle ? _react.default.createElement(_col.default, null, _react.default.createElement("div", null, column.getTitle()), column.renderInForm({
          isFilter: true,
          treeData: (0, _generateTreeData.default)(filterProps.filters || []),
          formComponentProps: (0, _objectSpread4.default)({}, column.getTableFilterComponentProps(), {
            ...
            onChange: function onChange(v) {
              ...
              _this2.onChange({
                filters: (0, _objectSpread4.default)({}, (0, _mapValues2.default)(filter, function (fv) {
                  return (0, _isArray2.default)(fv) ? fv : [fv];
                }), (0, _defineProperty2.default)({}, column.getTableFilterKey(), (0, _isUndefined2.default)(value) ? null : [column.formatFilterValue(value)])),
                columns: columns,
                useFilterKey: true,
            ...
            getPopupContainer: function getPopupContainer() {
              return document.getElementsByClassName('filters-table')[0];
            }
          })
    ...
    value: function renderExpandFilters(column) {
      ...
      var options = filters ? filters.map(function (_ref6) {
      ...
      return _react.default.createElement(_row.default, {
        ...
        value: fixedFilterValue,
        label: '全部'
      }].concat((0, _toConsumableArray2.default)(options)).map(function (_ref7) {
