  ...
  function RecordsPage() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "editRecord", function () {
      var _ref2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee2(id, body) {
        var _this$props3, patch, create, hide;

        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this$props3 = _this.props, patch = _this$props3.patch, create = _this$props3.create;
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    value: function () {
      var _fetch = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee3() {
        var _this$props5, fetch, page, pagesize, params;

        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _this$props5 = this.props, fetch = _this$props5.fetch, page = _this$props5.page, pagesize = _this$props5.pagesize, params = _this$props5.match.params;
                this.setState({
                  isLoading: true
                });
                _context3.prev = 2;
