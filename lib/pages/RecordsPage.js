...
var RecordsPage = function (_React$PureComponent) {
  ...
  function RecordsPage(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onChange", function () {
      var _ref3 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(pagination, filters, sorter) {
        var _this$props3, table, page, pagesize, search, updatePage, sort, filter, filterInGroupTableKeys, targetTable, tableSort, newSort, newFilter, newPage;

        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$props3 = _this.props, table = _this$props3.table, page = _this$props3.page, pagesize = _this$props3.pagesize, search = _this$props3.search, updatePage = _this$props3.updatePage, sort = _this$props3.sort, filter = _this$props3.filter;
                filterInGroupTableKeys = _this.state.filterInGroupTableKeys;
                targetTable = (0, _find2.default)(table, {
                  key: sorter.columnKey
                }) || {};
                tableSort = targetTable.sort;

                if (tableSort && sorter && sorter.columnKey && sorter.order) {
                  if (tableSort[sorter.order.replace('end', '')]) {
                    newSort = "".concat(targetTable.mapKey, " ").concat(sorter.order.replace('end', ''));
                  } else if (tableSort.asc) {
                    newSort = "".concat(targetTable.mapKey, " asc");
                  } else if (tableSort.desc) {
                    newSort = "".concat(targetTable.mapKey, " desc");
                  } else {
                    newSort = '';
                  }
                } else {
                ...
                newFilter = (0, _reduce2.default)(table, function (acc, _ref4) {
                  var key = _ref4.key,
                      type = _ref4.type,
                      mapKey = _ref4.mapKey,
    ...
    (0, _forEach2.default)(filterInGroupTables, function (_ref14) {
  ...
  (0, _createClass2.default)(RecordsPage, [{
    ...
    value: function renderColumn(_ref15) {
      ...
      var invisible = _ref15.invisible,
          link = _ref15.link,
          title = _ref15.title,
          key = _ref15.key,
          sort = _ref15.sort,
    ...
    value: function renderTable() {
      ...
      return table.map(function (definition) {
    ...
    value: function renderFilterGroup() {
      ...
      return _react.default.createElement(_Group.default, {
        title: "\u7B5B\u9009"
      }, filterInGroupTables.map(function (_ref20) {
...
(0, _defineProperty2.default)(RecordsPage, "propTypes", {
  ...
  table: _propTypes.default.arrayOf(_propTypes.default.shape({
