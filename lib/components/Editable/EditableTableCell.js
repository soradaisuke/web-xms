...
var _LinesEllipsis = _interopRequireDefault(require("../LinesEllipsis"));
...
function renderInTable(_ref) {
  ...
  if (maxLines > 0) {
    return _react.default.createElement(_LinesEllipsis.default, {
      text: value || '',
      maxLine: maxLines
    });
  }
...
function EditableTableCell(_ref2) {
  var children = _ref2.children,
      ...
      column = _ref2.column,
      reload = _ref2.reload,
      restProps = (0, _objectWithoutProperties2.default)(_ref2, ["children", "record", "column", "reload"]);
