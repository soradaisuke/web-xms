...
function FormItem(_ref) {
  ...
  var initialValue = (0, _react.useMemo)(function () {
    return getColumnInitialValue(column, matchParams);
  }, [column, matchParams]);
  ...
  var initialEditValue = (0, _react.useMemo)(function () {
    if (isEdit) {
  ...
  }, [column, form, isEdit, initialValue, initialEditValue, shouldSetInitialValue]);
  ...
  }, [prefix, column, hideLabel, normalize, initialValue, rules, valuePropName, extraCommonFormItemProps, initialEditValue, isEdit, shouldSetInitialValue]);
        ...
        shouldUpdate: function shouldUpdate(prevValues, curValues) {
          ...
          if (column.getFormItemAvailableWhen().size > 0) {
            return !!column.getFormItemAvailableWhen().find(function (_, key) {
              ...
              return (0, _get2.default)(prevValues, parsedKey) !== (0, _get2.default)(curValues, parsedKey);
            });
          }
    ...
    if (column.getFormRender()) {
      ...
      if (!column.isArray()) {
        ...
        inner = _react.default.createElement(_form.default.List, {
          ...
          }, _react.default.createElement(_icons.PlusOutlined, null), "\u6DFB\u52A0".concat(column.getTitle()))));
        });
      }
    }
