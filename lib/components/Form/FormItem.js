...
function FormItem(_ref) {
  ...
  var commonFormItemProps = (0, _react.useMemo)(function () {
    var _column$getFormItemIn, _column$getFormItemIn2, _column$getFormItemIn3;
    ...
    return _objectSpread(_objectSpread(_objectSpread({
      ...
      initialValue: (_column$getFormItemIn = (_column$getFormItemIn2 = column.getFormItemInitialValue()) === null || _column$getFormItemIn2 === void 0 ? void 0 : (_column$getFormItemIn3 = _column$getFormItemIn2.toJS) === null || _column$getFormItemIn3 === void 0 ? void 0 : _column$getFormItemIn3.call(_column$getFormItemIn2)) !== null && _column$getFormItemIn !== void 0 ? _column$getFormItemIn : column.getFormItemInitialValue(),
  ...
  var children = (0, _react.useMemo)(function () {
    ...
    if (column.getFormRender()) {
      ...
      inner = _react.default.createElement(_UploadFile.default, formItemComponentProps);
  ...
  }, [column, commonFormItemProps, formItemComponentProps, formItemProps.shouldUpdate, record, renderParams, idIdentifier, initialListItemValue, prefix]);
