...
var DynamicItem = function (_React$PureComponent) {
  ...
  var _super = _createSuper(DynamicItem);
  ...
  function DynamicItem() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onChange", function (_ref) {
      ...
      var newValue = _objectSpread(_objectSpread({}, values[index]), {}, (0, _defineProperty2.default)({}, column.getFormItemName(), value));

      if (column.childColumn) {
        (0, _forEach2.default)(column.childColumn, function (childColumn) {
          (0, _unset2.default)(newValue, childColumn.getFormItemName());
        });
      }
  ...
  (0, _createClass2.default)(DynamicItem, [{
    ...
    value: function calculateInitialValue() {
      ...
      if (columns) {
        columns.forEach(function (column) {
          (0, _set2.default)(initialValue, column.getFormItemName(), column.generateFormInitialValue());
        });
      }
    ...
    value: function renderFormItems(_ref2) {
      ...
      return _react.default.createElement(_col.default, null, columns.map(function (column) {
        ...
        var parentValue = column.parentColumn ? (0, _get2.default)(value, column.parentColumn.getFormItemName()) : null;
        var columnValue = (0, _get2.default)(value, column.getFormItemName());
        var params = {
          user: user,
          value: columnValue,
          values: value,
          ...
          }, (0, _defineProperty2.default)(_formComponentProps, column.getFormFiledValuePropName(), (0, _get2.default)(value, column.getFormItemName())), (0, _defineProperty2.default)(_formComponentProps, "onChange", function onChange(newValue) {
