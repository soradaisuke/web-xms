        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                _context.next = 9;
                return (0, _upload2.uploadImage)(options.file, {
                  ssoToken: ssoToken,
                  bucket: bucket,
...
var mapStateToProps = function mapStateToProps(state) {
  ...
  return {
    ssoToken: (_state$user = state.user) === null || _state$user === void 0 ? void 0 : _state$user.get('sso_token')
  };
};

var _default = (0, _dva.connect)(mapStateToProps)(UploadImage);
