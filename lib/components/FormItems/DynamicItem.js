...
var DynamicItem = function (_React$PureComponent) {
  ...
  function DynamicItem() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(DynamicItem)).call.apply(_getPrototypeOf2, [this].concat(args)));
      ...
      return _react.default.createElement(_col.default, null, columns.map(function (column) {
        ...
        var params = {
          ...
          formComponentProps: {
            ...
            value: (0, _get2.default)(value, column.getFormKey()),
