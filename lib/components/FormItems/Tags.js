...
var Tags = function (_React$PureComponent) {
  ...
  function Tags() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "saveInputRef", function (input) {
      _this.input = input;
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onInputChange", function (e) {
      _this.setState({
        inputValue: e.target.value
      });
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onInputConfirm", function () {
      ...
      if (!(0, _trim2.default)(inputValue)) {
        ...
        onChange((0, _toConsumableArray2.default)(tags).concat([inputValue]));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "showInput", function () {
      _this.setState({
        inputVisible: true
      }, function () {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onRemoveTag", function (tag) {
