...
var _generateTreeData = _interopRequireWildcard(require("../../utils/generateTreeData"));
  ...
  (0, _createClass2.default)(XMSTreeSelect, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_react.default.Fragment, null, this.renderRadioOptions(), _react.default.createElement(_treeSelect.default, (0, _extends2.default)({
        ...
        value: (0, _isArray2.default)(value) ? (0, _map2.default)(value, function (v) {
          return (0, _generateTreeData.formatTreeSelectValue)(v);
        }) : (0, _generateTreeData.formatTreeSelectValue)(value),
        allowClear: true,
        showSearch: true,
        treeData: treeData,
