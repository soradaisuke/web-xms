...
var CommonArray = function (_React$PureComponent) {
  ...
  var _super = _createSuper(CommonArray);
  ...
  function CommonArray() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onChange", function (index, v) {
  ...
  (0, _createClass2.default)(CommonArray, [{
    ...
    value: function render() {
      ...
      var _this$props5 = this.props,
          ...
          formItemProps = _this$props5.formItemProps;
      return _react.default.createElement(_col.default, null, (0, _size2.default)(value) > 0 && value.map(function (v, i) {
        ...
        }, formItemProps)), (0, _size2.default)(value) > 1 && _react.default.createElement(_icons.MinusCircleOutlined, {
          style: {
            fontSize: '18px',
            color: 'rgb(255, 0, 0)'
          },
...
(0, _defineProperty2.default)(CommonArray, "propTypes", {
  ...
  formItemProps: _propTypes.default.shape({})
});
