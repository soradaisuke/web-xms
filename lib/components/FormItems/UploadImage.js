...
var UploadImage = function (_React$PureComponent) {
  ...
  function UploadImage(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "uploadImage", function () {
      var _ref2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(options) {
        var _this$props, ssoToken, onChange, bucket, needCrop, pixelCrop, upYunSyncPreprocessor, url;

        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$props = _this.props, ssoToken = _this$props.ssoToken, onChange = _this$props.onChange, bucket = _this$props.bucket, needCrop = _this$props.needCrop;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "customRequest", function () {
      var _ref3 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee2(options) {
        var needCrop, fileSrc;
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                needCrop = _this.props.needCrop;
                ...
                _context2.prev = 3;
                _context2.next = 6;
                return _this.generateFileSrc(options.file);

              case 6:
                fileSrc = _context2.sent;
  ...
  (0, _createClass2.default)(UploadImage, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var paddingUrl = this.state.paddingUrl;
      var _this$props2 = this.props,
          onChange = _this$props2.onChange,
          _this$props2$limit = _this$props2.limit,
          maxWidth = _this$props2$limit.maxWidth,
          minWidth = _this$props2$limit.minWidth,
          maxHeight = _this$props2$limit.maxHeight,
          minHeight = _this$props2$limit.minHeight;
    ...
    value: function render() {
      var _this$props3 = this.props,
          ...
          ssoToken = _this$props3.ssoToken,
          onChange = _this$props3.onChange,
          needCrop = _this$props3.needCrop,
          props = (0, _objectWithoutProperties2.default)(_this$props3, ["title", "modalWidth", "ssoToken", "onChange", "needCrop"]);
