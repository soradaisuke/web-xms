...
var _generateDeviceId2 = _interopRequireDefault(require("@qt/web-core/lib/generateDeviceId"));
...
var UploadImage = function (_React$PureComponent) {
  ...
  function UploadImage(props) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                upYunSyncPreprocessor = "/strip/true".concat(needCrop ? "/crop/".concat(pixelCrop.width, "x").concat(pixelCrop.height, "a").concat(pixelCrop.x, "a").concat(pixelCrop.y) : '');
              ...
              case 7:
                _context.next = 9;
                return (0, _uploadFile.wrappedUploadImage)(options.file, {
                  ssoToken: ssoToken,
                  bucket: bucket,
              ...
              case 15:
                ...
                (0, _showError.default)(_context.t0.message || _context.t0, '上传失败');
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "setCropState", function (cropParameter) {
      _this.setState(function (prevState) {
        return {
          cropParameter: _objectSpread(_objectSpread({}, prevState.cropParameter), cropParameter)
        };
      });
    });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "beforeUpload", function (file) {
      ...
      if (!(isJPG || isPNG)) {
        (0, _showError.default)('文件格式要求是JPEG/JPG或PNG');
      } else if (!isLtMaxSize) {
        (0, _showError.default)("\u56FE\u7247\u5927\u5C0F\u8D85\u8FC7\u9650\u5236\uFF08".concat(fileMaxSize, "MB\uFF09"));
      }
  ...
  (0, _createClass2.default)(UploadImage, [{
    ...
    value: function render() {
      ...
      var uploadButton = _react.default.createElement("div", null, imageLoading || fileLoading ? _react.default.createElement(_icons.LoadingOutlined, null) : _react.default.createElement(_icons.PlusOutlined, null), _react.default.createElement("div", {
