...
function FilterDropDown(_ref) {
  ...
  var children = (0, _react.useMemo)(function () {
    if (column.getFilters(null, _Column.default.VALUE_OPTIONS_KEYS.DISABLED_IN_FILTER) || column.getValueOptionsSearchRequest() || column.getValueOptionsRequest()) {
  ...
  return _react.default.createElement("div", {
    ...
    type: "primary",
    onClick: confirm,
    icon: _react.default.createElement(_SearchOutlined2.default, null),
    size: "small",
    style: {
      width: 90,
      marginRight: 8
