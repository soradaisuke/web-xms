...
function DraggableTable(_ref) {
  ...
  var moveRow = (0, _useEventCallback2.default)(function (dragIndex, hoverIndex) {
    ...
    onDataSourceChange(copyDataSource, [getKey(dataSource[dragIndex]), getKey(dataSource[hoverIndex])], [dragIndex, hoverIndex]);
  ...
  var composeOnRow = (0, _react.useCallback)(function (record, index) {
    ...
    return _objectSpread(_objectSpread({}, onRow(record, index)), {}, {
      ...
      showArrowDown: pagination !== false && index === pageSize - 1 && index !== dataSource.length - 1
    });
...
DraggableTable.propTypes = {
  ...
  pagination: _propTypes.default.oneOfType([_propTypes.default.shape({
