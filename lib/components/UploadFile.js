...
var UploadFile = function (_React$PureComponent) {
  ...
  function UploadFile() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "postFileUrl", function () {
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                postFileUrl = _this.props.postFileUrl;
                _context.prev = 1;
                _context.next = 4;
                return (0, _makeCancelablePromise2.default)(postFileUrl(url, file));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "upload", function (options) {
      ...
      (0, _makeCancelablePromise2.default)((0, _uploadFile2.default)(options.file, {
        ssoToken: user ? user.get('sso_token') : ''
      })).then(function (url) {
        _this.postFileUrl(url, options.file);
      }, function (err) {
...
(0, _defineProperty2.default)(UploadFile, "propTypes", {
  ...
  postFileUrl: _propTypes.default.func.isRequired,
