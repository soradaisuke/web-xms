...
var UploadFile = function (_React$PureComponent) {
  ...
  function UploadFile() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return (0, _webCommon.makeCancelablePromise)(afterUpload(url, file));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "customRequest", function (options) {
      ...
      (0, _webCommon.makeCancelablePromise)((0, _uploadFile.wrappedUploadFile)(options.file, {
  ...
  (0, _createClass2.default)(UploadFile, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_upload.default, (0, _extends2.default)({
        ...
        type: "primary",
        loading: loading
      }, _react.default.createElement(_icons.UploadOutlined, null), title));
    }
  }]);
  return UploadFile;
