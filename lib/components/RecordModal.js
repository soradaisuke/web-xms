...
var _RecordFormItem = _interopRequireDefault(require("./RecordFormItem"));
  ...
  (0, _createClass2.default)(RecordModal, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("span", null, _react.default.createElement("span", {
        ...
        return visibility && (visibility === true || _this2.isEdit() && visibility.edit || !_this2.isEdit() && visibility.create);
