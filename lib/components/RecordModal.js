...
var RecordModal = function (_React$PureComponent) {
  _inherits(RecordModal, _React$PureComponent);
  ...
  function RecordModal() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(RecordModal)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "showModelHandler", function (e) {
      if (e) {
        e.stopPropagation();
      }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "hideModelHandler", function () {
      _this.setState({
        visible: false
      });
    });
...
_defineProperty(RecordModal, "displayName", 'RecordModal');

_defineProperty(RecordModal, "propTypes", {
