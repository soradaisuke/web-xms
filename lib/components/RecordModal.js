...
var RecordModal = function (_React$PureComponent) {
  ...
  (0, _createClass2.default)(RecordModal, [{
    ...
    value: function renderFormItem(_ref3) {
      ...
      var enable = (0, _isFunction2.default)(formConfig.enable) ? formConfig.enable(form) : true;
      var initialValue = this.isEdit() ? record[key] : '';

      if ((0, _isFunction2.default)(formConfig.generateInitValue)) {
        initialValue = formConfig.generateInitValue(initialValue);
      }

      var convertedType = type === IMAGE ? URL : type;
      var children;
        ...
        case URL:
          children = enable ? getFieldDecorator(key, {
            ...
            rules: [{
              ...
              type: convertedType,
              message: "\u683C\u5F0F\u4E0D\u6B63\u786E\uFF0C\u8981\u6C42\u4E3A".concat(convertedType)
            }].concat(formConfig.rules || [])
          })(type === NUMBER ? _react.default.createElement(_inputNumber.default, null) : _react.default.createElement(_input.default, null)) : null;
          break;
