...
var RecordModal = function (_React$PureComponent) {
  ...
  function RecordModal() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onOk", (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee2() {
      var _this$props, form, record, onOk, table;

      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _this$props = _this.props, form = _this$props.form, record = _this$props.record, onOk = _this$props.onOk, table = _this$props.table;
              _context2.next = 3;
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            formatValues = {};
                            (0, _forEach2.default)(table, function (_ref3) {
                              var key = _ref3.key,
                            ...
                            (0, _forEach2.default)(values, function (value, key) {
                              var targetTable = (0, _find2.default)(table, {
                                mapKey: key
                              }) || {};
                              var formConfig = targetTable.form || {};

                              if ((0, _isFunction2.default)(formConfig.generateSubmitValue)) {
                                formatValues[key] = formConfig.generateSubmitValue(value);
                              } else if ((0, _isFunction2.default)(targetTable.type.formatSubmitValue)) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "checkRelevant", function () {
      ...
      (0, _forEach2.default)(table, function (_ref4) {
  ...
  (0, _createClass2.default)(RecordModal, [{
    ...
    value: function renderFormItem(_ref6) {
      ...
      var _targetTable$form = targetTable.form,
          formConfig = _targetTable$form === void 0 ? {} : _targetTable$form,
          _targetTable$filters = targetTable.filters,
          filters = _targetTable$filters === void 0 ? [] : _targetTable$filters,
          mapKey = targetTable.mapKey,
          modalFilters = targetTable.modalFilters,
          childKey = targetTable.childKey;
    ...
    value: function render() {
      ...
      var targetTable = multipleKey ? table.filter(function (_ref7) {
        var mapKey = _ref7.mapKey;
        return mapKey === multipleKey;
      }) : table.filter(function (_ref8) {
        var creatable = _ref8.creatable,
            editable = _ref8.editable;
        return _this3.isEdit() && editable || !_this3.isEdit() && creatable;
      });
      ...
      }, targetTable.map(function (definition) {
