...
var _CommonArraylikeItems = _interopRequireDefault(require("./FormItems/CommonArraylikeItems"));
...
var STRING = _DataType.default.STRING,
    ...
    OBJECT = _DataType.default.OBJECT;
                          ...
                          case 0:
                            ...
                            (0, _forEach2.default)(values, function (value, key) {
                              ...
                              if ((0, _isFunction2.default)(formConfig.generateSubmitValue)) {
                                ...
                                formatValues[key] = value.map(function (v) {
                                  return v;
                                });
                              } else {
  ...
  (0, _createClass2.default)(RecordModal, [{
    ...
    value: function renderFormItem(_ref3) {
      ...
      if ((0, _isFunction2.default)(formConfig.generateInitValue)) {
        ...
        if ((0, _get2.default)(record, key)) {
          (0, _forEach2.default)((0, _get2.default)(record, key), function (v, i) {
      ...
      switch (type) {
        ...
        case OBJECT:
          ...
          })(_react.default.createElement(_CommonArraylikeItems.default, {
            title: formConfig.tip,
            max: formConfig.max,
