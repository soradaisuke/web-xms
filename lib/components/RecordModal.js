...
function RecordModal(_ref) {
  var children = _ref.children,
      ...
      props = (0, _objectWithoutProperties2.default)(_ref, ["children", "onOk", "columns", "title", "record", "records", "actions", "className"]);
  ...
  var onValuesChange = (0, _useEventCallback2.default)(function () {
    var _formProps$onValuesCh;

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return formProps === null || formProps === void 0 ? void 0 : (_formProps$onValuesCh = formProps.onValuesChange) === null || _formProps$onValuesCh === void 0 ? void 0 : _formProps$onValuesCh.call.apply(_formProps$onValuesCh, [formProps].concat(args, [form]));
  }, [formProps]);
