...
var DatePickerWithPresets = function (_React$PureComponent) {
  ...
  function DatePickerWithPresets() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "formatValue", function (value, format) {
      return value && value.format(format) || '';
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onChangeDate", function (date) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onOpenChange", function (open) {
      _this.setState({
        open: open
      });
    });
