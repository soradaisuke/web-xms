  ...
  (0, _forEach2.default)(routes, function (_ref2) {
    ...
    if ((0, _reactRouterDom.matchPath)(pathname, {
      ...
      if ((title || breadcrumb) && !inline) {
        ...
        breadcrumbTitle = (0, _pathToText.default)(breadcrumbTitle) || title;
        items.push(_react.default.createElement(_breadcrumb.default.Item, {
          key: path
        }, component ? _react.default.createElement(_reactRouterDom.NavLink, {
          exact: true,
...
var NavBreadcrumb = function (_React$PureComponent) {
  ...
  var _super = _createSuper(NavBreadcrumb);
