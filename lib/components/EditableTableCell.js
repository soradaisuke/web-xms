...
var EditableTableCell = function (_React$PureComponent) {
  ...
  function EditableTableCell() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderCell", function (form) {
      ...
      var editing = _this.state.editing;
      var columnCanEditInTable = column && submit && column.canShowInEditFrom({
        user: user,
        record: record
      });
      return editing && columnCanEditInTable && form ? _react.default.createElement(_form.default.Item, {
        style: {
          margin: 0
        }
      }, column.renderInForm({
  ...
  (0, _createClass2.default)(EditableTableCell, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          restProps = (0, _objectWithoutProperties2.default)(_this$props2, ["record", "index", "handleSave", "children", "submit"]);
