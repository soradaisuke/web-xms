      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (options.method && (0, _includes2.default)(['POST', 'PUT', 'PATCH', 'DELETE'], options.method) && ((0, _isPlainObject2.default)(newOptions.body) || (0, _isArray2.default)(newOptions.body))) {
