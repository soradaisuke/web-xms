...
var _isYouzi = _interopRequireDefault(require("./utils/isYouzi"));
...
function ConnectedRouter(_ref2) {
  ...
  return _react.default.createElement(_configProvider.default, {
    ...
    className: "xms-sider",
    collapsible: true,
    theme: _isTuboshu.default || _isYouzi.default ? 'light' : 'dark',
    collapsed: collapsed,
    onCollapse: onCollapse
  }, _react.default.createElement("div", {
    className: (0, _classnames.default)('logo', _isTuboshu.default ? 'tuboshu' : _isYouzi.default ? 'youzi' : '')
    ...
    return renderRoute(route);
  }), (!auth || user) && _react.default.createElement(Redirect, {
    from: "/",
    to: "/"
  })))), _react.default.createElement(_backTop.default, null))), _react.default.createElement(_Watermark.default, null));
}
