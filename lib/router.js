...
function RouterConfig(_ref) {
  ...
  return _react.default.createElement(_localeProvider.default, {
    ...
    return renderRoute(route);
  }), user && !homeRoute && firstAvaliableNonHomeRoutePath ? _react.default.createElement(_reactRouterDom.Redirect, {
    from: "/",
    to: firstAvaliableNonHomeRoutePath
  }) : null))), _react.default.createElement(_backTop.default, {
    target: function target() {
      return document.getElementsByClassName('xms-content')[0];
    }
  }))));
}
