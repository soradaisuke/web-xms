...
function RouterConfig(_ref) {
  ...
  }, _react.default.createElement(_router.Switch, null, !homeRoute && firstAvaliableNonHomeRoute ? _react.default.createElement(_router.Redirect, {
    from: "/",
    to: firstAvaliableNonHomeRoute.path
  }) : null, (0, _map2.default)(routes, function (route) {
    return renderRoute(route);
