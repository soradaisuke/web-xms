...
function ConnectedRouter(_ref2) {
  ...
  return _react.default.createElement(_configProvider.default, {
    ...
    routes: routes
  }), _react.default.createElement(Switch, null, (0, _map2.default)(routes, function (route) {
    return renderRoute(route);
  }), (!auth || !!user) && !homeRoute && firstAvaliableNonHomeRoutePath ? _react.default.createElement(Redirect, {
    from: "/",
    to: {
